...
var updateProfilePic = function(event) {
...
function showPassword() {
    if (document.getElementById("passEye").src.match('images/hidePass.png')) {
        document.getElementById("passEye").src = "images/showPass.png";
    ...
    } else if (document.getElementById("passEye").src.match('images/showPass.png')) {
        document.getElementById("passEye").src = "images/hidePass.png";
