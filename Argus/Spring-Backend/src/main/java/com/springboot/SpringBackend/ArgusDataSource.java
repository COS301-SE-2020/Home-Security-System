...
public class ArgusDataSource {
    ...
    public javax.sql.DataSource herokuDataSource() {
        String username = System.getenv("mxewdvawjquqsn");
        String password = System.getenv("4b9049fdc93a174ebae9d2a03688b3bd2f01638fe96748cc0014fe835e598af8");
        String dbUrl = System.getenv("jdbc:postgresql://ec2-18-203-7-163.eu-west-1.compute.amazonaws.com:5432/df8a232j9ndrq8");
