...
export class AddPersonComponent implements OnInit {
  ...
  public AddPerson(): void {
    const currentUser = this.db.database.ref('users/-MCq_y_DVbLLfbF5M61-');
    ...
    // let persons;
    const usersL = this.db.database.ref('users/-MCq_y_DVbLLfbF5M61-');
    const newPerson = {
      date_created: addDateUser,
      id: addName.value + d.getDate(),
      listedType: getRole,
      name: addName.value,
      photo: addPhoto
    };
    usersL.child('person').push(newPerson);
  }
}
