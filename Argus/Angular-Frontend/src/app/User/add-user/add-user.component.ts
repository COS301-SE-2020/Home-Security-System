  ...
  public AddDB(): void {
    ...
    function generateId() {
      ...
      for (let i = 0; i < email.value.length; i++) {
        const hex = email.value.charCodeAt(i).toString(16);
        result += (hex).slice(-4);
      }
      return result;
    }
