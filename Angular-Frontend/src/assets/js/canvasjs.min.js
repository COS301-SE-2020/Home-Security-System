...
(function () {
  ...
  function Ba(k) {
    k.roundRect = function (k, v, s, t, ra, D, w, E) {
      w && (this.fillStyle = w);
  ...
  function eb(k) {
    if (I.fSDec) k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
      I._fTWm && I._fTWm(k)
    })
  }
  ...
  function fb(k) {
    if (k._menuButton) k.exportEnabled ?
      Ka(k._menuButton) : ua(k._menuButton); else if (k.exportEnabled && t) {
      var l = !1;
  ...
  function La(k, l, v) {
    if (t && Za) {
      ...
      k.width = l * ja;
      k.height = v * ja;
      Qa !== Ma && (k.style.width = l + "px", k.style.height = v + "px", s.scale(ja, ja))
  ...
  function va(k, l, v) {
    ...
    v && (l.setAttribute("state", v), l.setAttribute("type", "button"), pa(k, l, {
      ...
      lineHeight: "0"
    }), l.setAttribute("title", k._cultureInfo[v + "Text"]), l.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + ib[v].image + "' alt='" + k._cultureInfo[v + "Text"] + "' />")
  }
  ...
  function Sa(k, l) {
    Sa.base.constructor.call(this, "Toolbar", "toolbar", l, null, k);
    this.chart = k;
  ...
  function Ha(k, l, v) {
    Ha.base.constructor.call(this, "Subtitle", "subtitles", l, v, k);
    this.chart = k;
    this.canvas = k.canvas;
    this.ctx = this.chart.ctx;
  ...
  var Ga = !1, I = {}, t = !!document.createElement("canvas").getContext, qa = {
    Chart: {
      width: 500,
      height: 400,
      zoomEnabled: !1,
  ...
  }, Ja = {en: {}}, w = t ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ea = t ? "Impact, Charcoal, sans-serif" :
    "Arial", za = {
  ...
  var U = 20, E = 14, Ua = {
    ...
    legend: {
      fontFamily: w, fontSize: 14, fontColor: ba, fontWeight: "bold", verticalAlign: "bottom",
      horizontalAlign: "center"
    },
  ...
  var U = 20, E = 14, $a = {
    ...
    data: [{
      indexLabelFontFamily: w, indexLabelFontSize: E, indexLabelFontColor: "#666666", indexLabelFontWeight: "normal",
      indexLabelLineThickness: 1
    }],
    axisX: [{
      titleFontFamily: w,
  ...
  Ea = {
    ...
    data: [{
      indexLabelFontFamily: w, indexLabelFontSize: E,
    ...
    axisY2: [{
      ...
      crosshair: {
        labelFontFamily: w, labelFontSize: E, labelFontColor: "#000000",
  ...
  (function () {
    ...
    I._fTWm = function (k) {
      if ("undefined" === typeof I.pro.sCH && !bb) try {
        var l = k[I.fSDec(I.obj.cntx)];
        l[I.fSDec(I.obj.txtBl)] = I.fSDec(I.obj.tp);
        l[I.fSDec(I.obj.fnt)] = 11 + I.fSDec(I.obj.fntStr);
        l[I.fSDec(I.obj.fSy)] = I.fSDec(I.obj.grClr);
        l[I.fSDec(I.obj.fTx)](I.fSDec(I.obj.trVs), 2, k.height - 11 - 2)
      } catch (v) {
      }
    }
  })();
  var Xa = {}, wa = null, jb =
      ...
      return function (E, P, M) {
        var G = M ? M.days : l, R = M ? M.months : s, V = M ? M.shortDays : v, S = M ? M.shortMonths : t;
        M = "";
        var I = !1;
        E = E && E.getTime ? E : E ? new Date(E) : new Date;
        if (isNaN(E)) throw SyntaxError("invalid date");
        "UTC:" === P.slice(0, 4) && (P = P.slice(4), I = !0);
        M = I ? "getUTC" : "get";
        var W = E[M + "Date"](), N = E[M + "Day"](), X = E[M + "Month"](), a = E[M + "FullYear"](), d = E[M + "Hours"](),
          c = E[M + "Minutes"](), b = E[M + "Seconds"](), e = E[M + "Milliseconds"](), f = I ? 0 : E.getTimezoneOffset();
        return M = P.replace(k, function (n) {
          switch (n) {
            case "D":
              return W;
            case "DD":
            ...
            case "zzz":
              return (0 < f ? "-" : "+") + $(Math.floor(Math.abs(f) / 60), 2) + $(Math.abs(f) % 60, 2);
            default:
      ...
      var t = v ? v.decimalSeparator : ".", w = v ? v.digitGroupSeparator :
        ",", D = "";
      l = String(l);
      var D = 1, E = v = "", P = -1, M = [], G = [], R = 0, I = 0, V = 0, S = !1, W = 0,
        E = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
      l = null;
      for (var N = 0; E && N < E.length; N++) if (l = E[N], "." === l && 0 > P) P = N; else {
        ...
        0 > P ? (M.push(l), "#" === l || "0" === l ? R++ : "," === l && V++) : (G.push(l), "#" !== l && "0" !== l || I++)
      }
      S && (l = Math.floor(k),
        E = -Math.floor(Math.log(k) / Math.LN10 + 1), W = 0 === k ? 0 : 0 === l ? -(R + E) : String(l).length - R, D /= Math.pow(10, W));
      0 > P && (P = N);
      D = (k * D).toFixed(I);
      l = D.split(".");
      D = (l[0] + "").split("");
      k = (l[1] + "").split("");
      D && "0" === D[0] && D.shift();
      for (S = E = N = I = P = 0; 0 < M.length;) if (l = M.pop(), "#" === l || "0" === l) if (P++, P === R) {
        var X = D, D = [];
        if ("0" === l) for (l = R - I - (X ? X.length : 0); 0 < l;) X.unshift("0"), l--;
        for (; 0 < X.length;) v = X.pop() + v, S++, 0 === S % E && (N === V && 0 < X.length) && (v = w + v)
      } else 0 < D.length ? (v = D.pop() + v, I++, S++) : "0" === l && (v = "0" + v, I++, S++), 0 === S %
      E && (N === V && 0 < D.length) && (v = w + v); else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (N++, E = S, S = 0, 0 < D.length && (v = w + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function (a) {
        return $(W, a.length)
      }));
      w = "";
      for (M = !1; 0 < G.length;) l = G.shift(), "#" === l || "0" === l ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), M = !0) : "0" === l && (w += "0", M =
        !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""), w += l.replace(/[0]+/, function (a) {
        return $(W, a.length)
      }));
      v += (M ? t : "") + w;
      return s ? "-" + v : v
    ...
    da = function (k, l, v, s, t, w, D, E, P, M, S, R, G) {
      "undefined" === typeof G && (G = 1);
      D = D || 0;
      E = E || "black";
      var I = 15 < s - l && 15 < t - v ? 8 : 0.35 * Math.min(s - l, t - v);
      k.beginPath();
      k.moveTo(l, v);
      k.save();
      k.fillStyle = w;
      ...
      k.globalAlpha = 1;
      0 < D && (G = 0 === D % 2 ? 0 : 0.5, k.beginPath(), k.lineWidth = D, k.strokeStyle = E, k.moveTo(l, v), k.rect(l - G, v - G, s - l + 2 * G, t - v + 2 * G), k.stroke());
      k.restore();
      ...
      !0 === M && (k.save(), k.beginPath(), k.moveTo(l, t), k.lineTo(l + I, t - I), k.lineTo(s - I, t - I), k.lineTo(s, t), k.closePath(), D = k.createLinearGradient((s + l) / 2, t - I, (s + l) / 2, t), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, .4)"), k.fillStyle = D, k.fill(), k.restore());
      !0 === S && (k.save(),
      ...
      !0 === R && (k.save(), k.beginPath(), k.moveTo(s, v), k.lineTo(s - I, v + I), k.lineTo(s - I, t - I), k.lineTo(s, t), D = k.createLinearGradient(s - I, (t + v) / 2, s, (t + v) / 2), D.addColorStop(0, w), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = D, D.addColorStop(0, w), D.addColorStop(1,
    ...
    hb = bb && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),
    ib = {
  ...
  W.prototype.setOptions = function (k, l) {
  ...
  W.prototype.set = function (k, l, s) {
  ...
  W.prototype.addTo = function (k, l, s, t) {
  ...
  W.prototype.updateOption = function (k) {
    ...
    var l = qa[this._defaultsKey], t = {}, w = this[k], E = this._themeOptionsKey,
      I = this._index;
    this.theme && s(this.parent) && s(E) && s(I) ? t = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === I ? t = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (t = Math.min(this.parent.themeOptions[E].length - 1, I), t = this.parent.themeOptions[E][t]));
    this.themeOptions = t;
  ...
  W.prototype.dispatchEvent = function (k, l, s) {
  ...
  Da.prototype.registerSpace = function (k, l) {
  ...
  Da.prototype.unRegisterSpace = function (k, l) {
    "top" === k ? this._topOccupied -= l.height : "bottom" === k ? this._bottomOccupied -= l.height : "left" === k ? this._leftOccupied -= l.width : "right" === k && (this._rightOccupied -= l.width)
  };
  ...
  la.prototype.render = function (k) {
    if (0 !== this.fontSize) {
      ...
      var t = 0, w = this.topPadding, E = null;
  ...
  la.prototype.measureText = function () {
    this._lineHeight =
      Wa(this.fontFamily, this.fontSize, this.fontWeight);
    if (null === this.maxWidth) throw"Please set maxWidth and height for TextBlock";
    this._wrapText(this.ctx);
    this._isDirty = !1;
    return {width: this.width, height: this.height}
  };
  la.prototype._getLineWithWidth = function (k, l, s) {
    k = String(k);
    if (!k) return {text: "", width: 0};
    var t = s = 0, w = k.length - 1, E = Infinity;
    for (this.ctx.font = this._getFontString(); t <= w;) {
      var E = Math.floor((t + w) / 2), D = k.substr(0, E + 1);
      s = this.ctx.measureText(D).width;
      if (s < l) t = E + 1; else if (s > l) w = E - 1; else break
    }
    s >
    l && 1 < D.length && (D = D.substr(0, D.length - 1), s = this.ctx.measureText(D).width);
    l = !0;
    if (D.length === k.length || " " === k[D.length]) l = !1;
    l && (k = D.split(" "), 1 < k.length && k.pop(), D = k.join(" "), s = this.ctx.measureText(D).width);
    return {text: D, width: s}
  };
  la.prototype._wrapText = function () {
    var k = new String(Fa(String(this.text))), l = [], s = this.ctx.font, t = 0, w = 0;
    this.ctx.font = this._getFontString();
    if (0 === this.frontSize) w = t = 0; else for (; 0 < k.length;) {
      var E = this.maxHeight - (this.topPadding + this.bottomPadding), D = this._getLineWithWidth(k,
        this.maxWidth - (this.leftPadding + this.rightPadding), !1);
      D.height = this._lineHeight;
      l.push(D);
      var I = w, w = Math.max(w, D.width), t = t + D.height, k = Fa(k.slice(D.text.length, k.length));
      E && t > E && (D = l.pop(), t -= D.height, w = I)
    }
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = k.layoutManager.getFreeSpace(), t = l.x1,
        w = l.y1, E = 0, I = 0,
        D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, P, G;
      ...
      var M;
      s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top :
        this.padding.bottom ? this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0, M *= 1.25) : M = 2.5 * this.padding;
      this.wrap || (I = Math.min(I, Math.max(1.5 * this.fontSize, this.fontSize + M)));
      I = new la(this.ctx, {
      ...
      M = I.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = l.y1 + 2, G = "top") : "bottom" === this.verticalAlign && (w = l.y2 - 2 - M.height, G = "bottom"), "left" === this.horizontalAlign ? t = l.x1 + 2 : "center" === this.horizontalAlign ? t = l.x1 + l.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (t = l.x2 - 2 - M.width - D), P = this.horizontalAlign,
        this.width = M.width, this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (t = l.x1 + 2, w = l.y2 - 2 - (this.maxWidth / 2 - M.width / 2), E = -90, G = "left", this.width = M.height, this.height = M.width) : "right" === this.horizontalAlign ? (t = l.x2 - 2, w = l.y1 + 2 + (this.maxWidth / 2 - M.width / 2), E = 90, G = "right", this.width = M.height, this.height = M.width) : "center" === this.horizontalAlign && (w = k.y1 + (k.height / 2 - M.height / 2), t = k.x1 + (k.width / 2 - M.width / 2), G = "center", this.width = M.width, this.height = M.height), P = "center");
      I.x =
        t;
      I.y = w;
      I.angle = E;
  ...
  Ta.prototype.get = function (k, l) {
    var s =
      null;
    0 < this.pool.length ? (s = this.pool.pop(), La(s, k, l)) : s = ta(k, l);
    return s
  };
  ...
  var Oa = {
    addTheme: function (k, l) {
      ...
      s = s || "en";
      if (Ja[s]) return fa(k, l || "#,##0.##", new Ia(s));
      throw"Unknown Culture Name";
    }, formatDate: function (k, l, s) {
      s = s || "en";
      if (Ja[s]) return Aa(k, l || "DD MMM YYYY", new Ia(s));
      throw"Unknown Culture Name";
    }
  };
  ...
  w = Oa.Chart = function () {
    ...
    function l(a, d, c) {
      ...
      (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx), t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
        ...
        "top", Ba(this.overlaidCanvasCtx)), this._eventManager = new ea(this), this.windowResizeHandler = V(window, "resize", function () {
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++) if (0 == e) c.push(a[0]); else {
        ...
        b = Math.abs((a[n].x - a[f].x) / (0 === a[n].x - a[m].x ? 0.01 : a[n].x - a[m].x)) * (d - 1) /
          2 + 1;
        var A = (a[n].x - a[f].x) / b;
        b = (a[n].y - a[f].y) / b;
    ...
    function w(a, d, c, b, e, f, n, m, A, g) {
      var r = 0;
      g ? (n.color = f, m.color = f) :
        g = 1;
      ...
      a.setLineDash && a.setLineDash(P(m.dashType, m.thickness));
      a.beginPath();
      A && 0 < m.thickness ? (a.moveTo(b - n.thickness / 2, Math.round((c + e) / 2) - q), a.lineTo(d + n.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < m.thickness && (a.moveTo(Math.round((d +
        b) / 2) - q, c + n.thickness / 2), a.lineTo(Math.round((d + b) / 2) - q, e - n.thickness / 2));
      a.stroke();
      a.strokeStyle = n.color || f;
      a.lineWidth = n.thickness || 2;
      a.setLineDash && a.setLineDash(P(n.dashType, n.thickness));
      a.beginPath();
    ...
    l.prototype._updateOptions = function () {
      ...
      if (this.options.zoomEnabled || this.panEnabled) {
        ...
        this._resetButton || (d = !1, ua(this._resetButton = document.createElement("button")), va(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), V(this._resetButton, "touchstart", function (a) {
          ...
          a.toolTip.dispatchEvent("hidden",
            {chart: a, toolTip: a.toolTip}, a.toolTip);
        ...
        this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled =
          !1), Ka(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))
      ...
      for (var c in this.toolTip.options) this.toolTip.options.hasOwnProperty(c) &&
      this.toolTip.updateOption(c)
    };
    l.prototype._updateSize = function () {
      ...
      if (this.canvas.width !== d * ja || this.canvas.height !== c * ja) {
        ...
        this.bounds = {
          x1: 0, y1: 0, x2: this.width,
          y2: this.height, width: this.width, height: this.height
        };
        a = !0
      } else a = !1;
      return a
    ...
    l.prototype._initialize = function () {
      ...
      if (this.options.data) {
        for (var c = 0; c < this.options.data.length; c++) if (a++, !this.options.data[c].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[c].type)) {
          ...
          "error" === b.type && (b.linkedDataSeriesIndex = s(this.options.data[c].linkedDataSeriesIndex) ? c - 1 : this.options.data[c].linkedDataSeriesIndex, 0 > b.linkedDataSeriesIndex || b.linkedDataSeriesIndex >= this.options.data.length || "number" !== typeof b.linkedDataSeriesIndex ||
          "error" === this.options.data[b.linkedDataSeriesIndex].type) && (b.linkedDataSeriesIndex = null);
          ...
          "rangeArea" === b.type || "rangeSplineArea" === b.type || "candlestick" === b.type || "ohlc" === b.type || "waterfall" === b.type || "boxAndWhisker" === b.type ? [this._selectedColorSet[0]] : this._selectedColorSet : b._colorSet = [b.color];
    ...
    l._supportedChartTypes =
      Ca("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
    l.prototype.setLayout = function () {
      ...
      if (this.axisX) for (c = 0; c < this.axisX.length; c++) "undefined" === typeof this.axisX[c].options.gridThickness &&
      ...
      c ? (Ka(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor, this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness :
        0) + "px solid " + this.toolbar.borderColor) : (ua(this._zoomButton, this._resetButton), this._toolBar.style.border = this.toolbar.borderThickness + "px solid transparent", this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
      eb(this);
      this._processData();
      ...
      this.subtitles = [];
      if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) c = new Ha(this, this.options.subtitles[d],
      ...
      for (d = 0; d < this._axes.length; d++) if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
        t ?
          (this._breaksCanvas = ta(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
        break
      }
    ...
    l.prototype.renderElements =
      function () {
        ...
        t && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++) for (var f = this.plotInfo.plotTypes[d], n = 0; n < f.plotUnits.length; n++) {
          ...
          "line" === m.type ? A = this.renderLine(m) : "stepLine" === m.type ? A = this.renderStepLine(m) :
            "spline" === m.type ? A = this.renderSpline(m) : "column" === m.type ? A = this.renderColumn(m) : "bar" === m.type ? A = this.renderBar(m) : "area" === m.type ? A = this.renderArea(m) : "stepArea" === m.type ? A = this.renderStepArea(m) : "splineArea" === m.type ? A = this.renderSplineArea(m) : "stackedColumn" === m.type ? A = this.renderStackedColumn(m) : "stackedColumn100" === m.type ? A = this.renderStackedColumn100(m) : "stackedBar" === m.type ? A = this.renderStackedBar(m) : "stackedBar100" === m.type ? A = this.renderStackedBar100(m) : "stackedArea" === m.type ? A = this.renderStackedArea(m) :
              "stackedArea100" === m.type ? A = this.renderStackedArea100(m) : "bubble" === m.type ? A = A = this.renderBubble(m) : "scatter" === m.type ? A = this.renderScatter(m) : "pie" === m.type ? this.renderPie(m) : "doughnut" === m.type ? this.renderPie(m) : "funnel" === m.type ? A = this.renderFunnel(m) : "pyramid" === m.type ? A = this.renderFunnel(m) : "candlestick" === m.type ? A = this.renderCandlestick(m) : "ohlc" === m.type ? A = this.renderCandlestick(m) : "rangeColumn" === m.type ? A = this.renderRangeColumn(m) : "error" === m.type ? A = this.renderError(m) : "rangeBar" === m.type ?
                A = this.renderRangeBar(m) : "rangeArea" === m.type ? A = this.renderRangeArea(m) : "rangeSplineArea" === m.type ? A = this.renderRangeSplineArea(m) : "waterfall" === m.type ? A = this.renderWaterfall(m) : "boxAndWhisker" === m.type && (A = this.renderBoxAndWhisker(m));
          for (var g = 0; g < m.dataSeriesIndexes.length; g++) this._dataInRenderedOrder.push(this.data[m.dataSeriesIndexes[g]]);
        ...
        if (0 < c.length) r.disableToolTip = !0, r._animator.animate(200, r.animationDuration, function (a) {
          ...
          r.ctx.drawImage(b, 0, 0, Math.floor(r.width * ja), Math.floor(r.height * ja), 0, 0, r.width, r.height);
          for (var e =
          ...
          if (r._breaksCanvas) if (t) r.plotArea.ctx.drawImage(r._breaksCanvas, 0, 0, this.width, this.height); else for (g = 0; g < r._axes.length; g++) r._axes[g].createMask();
        ...
        this.renderCount++;
        Ga && (r = this, setTimeout(function () {
          var a = document.getElementById("ghostCanvasCopy");
          a && (La(a, r.width, r.height), a.getContext("2d").drawImage(r._eventManager.ghostCanvas, 0, 0))
        }, 2E3));
        this._breaksCanvas && (delete this._breaksCanvas, delete this._breaksCanvasCtx);
        for (g = 0; g < this._axes.length; g++) this._axes[g].maskCanvas && (delete this._axes[g].maskCanvas, delete this._axes[g].maskCtx)
      };
    ...
    l.prototype.categoriseDataSeries = function () {
      for (var a = "", d = 0; d < this.data.length; d++) if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
        for (var c =
          null, b = !1, e = null, f = !1, n = 0; n < this.plotInfo.plotTypes.length; n++) if (this.plotInfo.plotTypes[n].type === a.type) {
          b = !0;
    ...
    l.prototype._processData =
      function () {
        this.assignIdToDataPoints();
        this.categoriseDataSeries();
        for (var a = 0; a < this.plotInfo.plotTypes.length; a++) for (var d = this.plotInfo.plotTypes[a], c = 0; c < d.plotUnits.length; c++) {
          var b = d.plotUnits[c];
          "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type ? this._processMultiseriesPlotUnit(b) : "stackedColumn" === b.type || "stackedBar" === b.type || "stackedArea" === b.type ?
            this._processStackedPlotUnit(b) : "stackedColumn100" === b.type || "stackedBar100" === b.type || "stackedArea100" === b.type ? this._processStacked100PlotUnit(b) : "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? this._processMultiYPlotUnit(b) : "waterfall" === b.type && this._processSpecificPlotUnit(b)
        }
        this.calculateAutoBreaks()
      };
    l.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes &&
        !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
        var m = this.data[a.dataSeriesIndexes[n]], A = 0, g = !1, r = !1, q;
        if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var p = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ?
          0 : -Infinity,
          h = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
        ...
        for (A = 0; A < m.dataPoints.length; A++) {
          ...
          m.dataPoints[A].x.getTime ?
            (f = !0, b = m.dataPoints[A].x.getTime()) : b = m.dataPoints[A].x;
          e = m.dataPoints[A].y;
          b < c.min && (c.min = b);
          b > c.max && (c.max = b);
          ...
          if (0 < A) {
            ...
            null !== e && null !== m.dataPoints[A - 1].y && (a.axisY.logarithmic ? (C = e / m.dataPoints[A - 1].y, 1 > C && (C = 1 / C), d.minDiff > C && 1 !== C && (d.minDiff =
              C)) : (C = e - m.dataPoints[A - 1].y, 0 > C && (C *= -1), d.minDiff > C && 0 !== C && (d.minDiff = C)))
          }
          if (b < p && !g) null !== e && (q = b); else {
            if (!g && (g = !0, 0 < A)) {
              A -= 2;
              continue
            }
            if (b > h && !r) r = !0; else if (b > h && r) continue;
    ...
    l.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = [], m = [], A = Infinity, g = -Infinity, r = 0; r < a.dataSeriesIndexes.length; r++) {
          var q = this.data[a.dataSeriesIndexes[r]], p = 0, h = !1, C = !1, k;
          if ("normal" === q.axisPlacement || "xySwapped" === q.axisPlacement) var aa = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
          ...
          for (p = 0; p < q.dataPoints.length; p++) {
            "undefined" ===
            typeof q.dataPoints[p].x && (q.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
            ...
            if (0 < p) {
              ...
              null !== e && null !== q.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < e && (l = e / q.dataPoints[p -
              1].y, 1 > l && (l = 1 / l), d.minDiff > l && 1 !== l && (d.minDiff = l)) : (l = e - q.dataPoints[p - 1].y, 0 > l && (l *= -1), d.minDiff > l && 0 !== l && (d.minDiff = l)))
            }
            if (b < aa && !h) null !== q.dataPoints[p].y && (k = b); else {
              if (!h && (h = !0, 0 < p)) {
                p -= 2;
                continue
              }
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === q.dataPoints[p].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ?
                n[b] ? n[b] += e : (n[b] = e, A = Math.min(e, A)) : m[b] ? m[b] += e : (m[b] = e, g = Math.max(e, g)))
            }
          }
        ...
        for (p in n) n.hasOwnProperty(p) && !isNaN(p) && (a = n[p], a <
        d.min && (d.min = Math.min(a, A)), a > d.max && (d.max = a), p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)), a > d.viewPortMax && (d.viewPortMax = a)));
        for (p in m) m.hasOwnProperty(p) && !isNaN(p) && (a = m[p], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, g)), p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, g))))
      }
    };
    l.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d =
          a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = !1, m = !1, A = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
          var r = this.data[a.dataSeriesIndexes[g]], q = 0, p = !1, h = !1, C;
          ...
          for (q = 0; q < r.dataPoints.length; q++) {
            ...
            if (b < k && !p) null !== e && (C = b);
              ...
              if (b > l && !h) h = !0; else if (b > l && h) continue;
        ...
        a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase,
    ...
    l.prototype._processMultiYPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, n, m = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
        var g = this.data[a.dataSeriesIndexes[A]], r = 0, q = !1, p = !1, h, C, k;
        if ("normal" === g.axisPlacement || "xySwapped" === g.axisPlacement) var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum :
          this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
          u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
        if (g.dataPoints[r].x && g.dataPoints[r].x.getTime || "dateTime" === g.xValueType) m = !0;
        for (r = 0; r < g.dataPoints.length; r++) {
          "undefined" === typeof g.dataPoints[r].x &&
          (g.dataPoints[r].x = r + (a.axisX.logarithmic ? 1 : 0));
          g.dataPoints[r].x.getTime ? (m = !0, b = g.dataPoints[r].x.getTime()) : b = g.dataPoints[r].x;
          if ((e = g.dataPoints[r].y) && e.length) {
          ...
          f < d.min && (d.min = f);
          n > d.max && (d.max = n);
          0 < r && (a.axisX.logarithmic ? (C = b / g.dataPoints[r - 1].x, 1 > C && (C = 1 / C), c.minDiff > C && 1 !== C && (c.minDiff = C)) : (C = b - g.dataPoints[r - 1].x, 0 > C && (C *= -1), c.minDiff >
          C && 0 !== C && (c.minDiff = C)), e && (null !== e[0] && g.dataPoints[r - 1].y && null !== g.dataPoints[r - 1].y[0]) && (a.axisY.logarithmic ? (C = e[0] / g.dataPoints[r - 1].y[0], 1 > C && (C = 1 / C), d.minDiff > C && 1 !== C && (d.minDiff = C)) : (C = e[0] - g.dataPoints[r - 1].y[0], 0 > C && (C *= -1), d.minDiff > C && 0 !== C && (d.minDiff = C))));
          if (!(b < l) || q) {
            if (!q && (q = !0, 0 < r)) {
              r -= 2;
              h = k;
            ...
            g.dataPoints[r].label && (a.axisX.labels[b] = g.dataPoints[r].label);
            b < c.viewPortMin && (c.viewPortMin = b);
            b > c.viewPortMax && (c.viewPortMax = b);
            if (c.viewPortMin === b && e) for (x = 0; x < e.length; x++) if (null === e[x] && h < b) {
              c.viewPortMin = h;
              break
            }
            null === e ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (f < d.viewPortMin && (d.viewPortMin = f), n > d.viewPortMax && (d.viewPortMax = n))
          }
        }
        g.axisX.valueType = g.xValueType = m ? "dateTime" : "number"
      }
    };
    l.prototype._processSpecificPlotUnit = function (a) {
      if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
        var m = this.data[a.dataSeriesIndexes[n]],
          A = 0, g = !1, r = !1, q = b = 0;
        if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var p = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity,
          h = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
            this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
        if (m.dataPoints[A].x && m.dataPoints[A].x.getTime || "dateTime" === m.xValueType) f = !0;
        for (A = 0; A < m.dataPoints.length; A++) "undefined" !== typeof m.dataPoints[A].isCumulativeSum && !0 === m.dataPoints[A].isCumulativeSum ? (m.dataPointEOs[A].cumulativeSumYStartValue = 0, m.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum, m.dataPoints[A].y = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum) :
        ...
        q && 1 !== q && (c.minDiff = q)) : (q = b - m.dataPoints[A - 1].x, 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q)), null !== e && null !== m.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = m.dataPointEOs[A].cumulativeSum / m.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = m.dataPointEOs[A].cumulativeSum - m.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < p) || g) {
          if (!g && (g = !0, 0 < A)) {
            A -= 2;
            continue
          }
          if (b > h && !r) r = !0; else if (b > h && r) continue;
          m.dataPoints[A].label && (a.axisX.labels[b] =
    ...
    l.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, g = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
            var k = e.data[a.dataSeriesIndexes[A]];
            if (!(4 > k.dataPoints.length)) for (q = 0; q < k.dataPoints.length; q++) if (b && (p = (n + 1 - g) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() :
              k.dataPoints[q].x, p = Math.floor((h - g) / p), h < f[p].min && (f[p].min = h), h > f[p].max && (f[p].max = h)), c) {
              var l = (r + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
              if ((h = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && h.length) for (var t = 0; t < h.length; t++) p = Math.floor((h[t] - m) / l), h[t] < d[p].min && (d[p].min = h[t]), h[t] > d[p].max && (d[p].max = h[t]); else s(h) || (p = Math.floor((h - m) / l), h < d[p].min && (d[p].min = h), h > d[p].max && (d[p].max = h))
            }
          }
        }
      }
      ...
      function c(a) {
        if (a.dataSeriesIndexes &&
          !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, g = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
          var m = e.data[a.dataSeriesIndexes[n]];
          if (!(4 > m.dataPoints.length)) for (g = 0; g < m.dataPoints.length; g++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[g].x.getTime ? m.dataPoints[g].x.getTime() : m.dataPoints[g].x, h = Math.floor((b -
            c) / h), b < f[h].min && (f[h].min = b), b > f[h].max && (f[h].max = b)
        }
      }
      ...
      if (f) {
        for (n = 0; n < this.plotInfo.plotTypes.length; n++) for (f = this.plotInfo.plotTypes[n],
        ...
        for (n = 0; n < this._axes.length; n++) if (this._axes[n].dataInfo._dataRanges) {
          ...
          if (this._axes[n].dataInfo.dataPointYNegativeSums) {
            p =
              this._axes[n].dataInfo.dataPointYNegativeSums;
            r = g;
            for (m in p) p.hasOwnProperty(m) && !isNaN(m) && (q = -1 * p[m], s(q) || (h = Math.floor((q - A) / b), q < r[h].min && (r[h].min = q), q > r[h].max && (r[h].max = q)));
            delete this._axes[n].dataInfo.dataPointYNegativeSums
          }
          for (m = 0; m < g.length - 1; m++) if (r = g[m].max, isFinite(r)) for (; m < g.length - 1;) if (A = g[m + 1].min, isFinite(A)) {
            q = A - r;
            q > b && f.push({diff: q, start: r, end: A});
            break
          } else m++;
          if (this._axes[n].scaleBreaks.customBreaks) for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++) for (b =
    ...
    l.prototype.getDataPointAtXY =
      function (a, d, c) {
        ...
        a = null;
        d = !1;
        for (c = 0; c < b.length; c++) if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type) if (e = ma("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) {
          d = !0;
          break
        }
    ...
    l.prototype.getObjectAtXY = function (a, d, c) {
      var b = null;
      if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (t) b = Ya(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        var e = this.legend.items[c];
        a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (b = e.id)
      }
      return b
    };
    l.prototype.getAutoFontSize = kb;
    l.prototype.resetOverlayedCanvas =
      function () {
        this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height)
      };
    l.prototype.clearCanvas = jb;
    ...
    l.prototype._mouseEventHandler = function (a) {
      ...
      l.capturedEventParam && (b = l.capturedEventParam, "mouseup" === c && (l.capturedEventParam = null, b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
        b.chart._mouseEventHandler, !1)), b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && t || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
      if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Ga && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which),
      "mouseup" === c && window.console.log("mouseup")), !e) {
        ...
        if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) if (this.toolTip && this.toolTip.enabled) {
          ...
          for (f = 0; f < this.axisX.length; f++) this.axisX[f].crosshair && this.axisX[f].crosshair.enabled && this.axisX[f].crosshair.dispatchEvent("hidden",
            {chart: this, axis: this.axisX[f].options}, this.axisX[f].crosshair);
    ...
    l.prototype._plotAreaMouseUp = function (a, d) {
      if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
        var c =
          d - this.dragStartPoint.y, b = a - this.dragStartPoint.x, e = 0 <= this.zoomType.indexOf("x"),
          f = 0 <= this.zoomType.indexOf("y"), n = !1;
        this.resetOverlayedCanvas();
        if ("xySwapped" === this.plotInfo.axisPlacement) var m = f, f = e, e = m;
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled) for (e = f = 0; e < this._axes.length; e++) c = this._axes[e], c.logarithmic ? c.viewportMinimum < c.minimum ? (f = c.minimum / c.viewportMinimum, c.sessionVariables.newViewportMinimum = c.viewportMinimum * f, c.sessionVariables.newViewportMaximum = c.viewportMaximum *
          ...
          n && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type =
            ...
            this._resetButton), va(this, this._zoomButton, "pan"), va(this, this._resetButton, "reset")))
        }
      }
      this.isDrag = !1;
      if ("none" !== this.plotInfo.axisPlacement) {
        ...
        if (this.axisY &&
          0 < this.axisY.length) for (n = 0; n < this.axisY.length; n++) this.axisY[n].crosshair && this.axisY[n].crosshair.enabled && this.axisY[n].renderCrosshair(a, d);
    ...
    l.prototype._plotAreaMouseMove = function (a, d) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        var c = 0, b = 0, e = c = null, e = 0 <= this.zoomType.indexOf("x"), f = 0 <= this.zoomType.indexOf("y"),
          n = this;
        ...
        if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) if (this.panEnabled) e = {
          ...
          return function () {
            n._zoomPanToSelectedRegion(b, c, e, f, !0) && (n._dispatchRangeEvent("rangeChanging", "pan"), n.stockChart && (n.stockChart.navigator && n.stockChart.navigator.enabled) && (n.stockChart._rangeEventParameter.type = "rangeChanging", n.stockChart.dispatchEvent("rangeChanging", n.stockChart._rangeEventParameter, n.stockChart)), n.render(),
              n._dispatchRangeEvent("rangeChanged", "pan"), n.stockChart && (n.stockChart.navigator && n.stockChart.navigator.enabled) && (n.stockChart._rangeEventParameter.type = "rangeChanged", n.stockChart.dispatchEvent("rangeChanged", n.stockChart._rangeEventParameter, n.stockChart)), n.dragStartPoint.x = a, n.dragStartPoint.y = d)
          }
          ...
          var b = e ? this.dragStartPoint.x : this.plotArea.x1,
            ...
            g = f ? d - this.dragStartPoint.y : this.plotArea.y2 - this.plotArea.y1;
          ...
          this.overlaidCanvasCtx.fillRect(b, m, A, g);
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      e = e || !1;
      for (var f = 0 <= this.zoomType.indexOf("x"), n = 0 <= this.zoomType.indexOf("y"), m = !1, A = [], g = [], r = [], q = 0; q < this._axes.length; q++) ("axisX" === this._axes[q].type && f || "axisY" === this._axes[q].type && n) && g.push(this._axes[q]);
      for (n = 0; n < g.length; n++) {
        var q = g[n], f = !1, p = q.convertPixelToValue({x: a, y: d}), h = q.convertPixelToValue({
          x: c,
          y: b
        });
        if (p > h) var C = h, h = p, p = C;
        if (q.scaleBreaks) for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++) f = q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= h;
        if (isFinite(q.dataInfo.minDiff)) if (C = q.getApparentDifference(p, h, null, !0), !(f || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && C < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && C < 3 * Math.abs(q.dataInfo.minDiff)) || p < q.minimum || h > q.maximum)) A.push(q), r.push({
          val1: p,
          val2: h
        }),
          m = !0; else if (!e) {
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var g = this._indexLabels[a], r = g.chartType.toLowerCase(), q, p, m = ma("indexLabelFontColor", g.dataPoint,
          g.dataSeries), A = ma("indexLabelFontSize", g.dataPoint, g.dataSeries);
        ...
        var n = ma("indexLabelFontWeight", g.dataPoint, g.dataSeries),
          h = ma("indexLabelBackgroundColor", g.dataPoint, g.dataSeries),
          e = ma("indexLabelMaxWidth", g.dataPoint, g.dataSeries), f = ma("indexLabelWrap", g.dataPoint, g.dataSeries),
          C = ma("indexLabelLineDashType", g.dataPoint, g.dataSeries),
          k = ma("indexLabelLineColor", g.dataPoint, g.dataSeries), l =
            s(g.dataPoint.indexLabelLineThickness) ? s(g.dataSeries.options.indexLabelLineThickness) ? 0 : g.dataSeries.options.indexLabelLineThickness : g.dataPoint.indexLabelLineThickness,
        ...
        if (0 <= g.dataSeries.type.indexOf("stacked") || "pie" === g.dataSeries.type || "doughnut" === g.dataSeries.type) u = this.getPercentAndTotal(g.dataSeries, g.dataPoint);
        if (g.dataSeries.indexLabelFormatter ||
          g.dataPoint.indexLabelFormatter) x = {
          chart: this,
          dataSeries: g.dataSeries,
          dataPoint: g.dataPoint,
          index: g.indexKeyword,
          total: u.total,
          percent: u.percent
        };
        var z = g.dataPoint.indexLabelFormatter ? g.dataPoint.indexLabelFormatter(x) : g.dataPoint.indexLabel ? this.replaceKeywordsWithValue(g.dataPoint.indexLabel, g.dataPoint, g.dataSeries, null, g.indexKeyword) : g.dataSeries.indexLabelFormatter ? g.dataSeries.indexLabelFormatter(x) : g.dataSeries.indexLabel ? this.replaceKeywordsWithValue(g.dataSeries.indexLabel, g.dataPoint, g.dataSeries,
          null, g.indexKeyword) : null;
        if (null !== z && "" !== z) {
          var u = ma("indexLabelPlacement", g.dataPoint, g.dataSeries),
            x = ma("indexLabelOrientation", g.dataPoint, g.dataSeries), J = g.direction, y = g.dataSeries.axisX,
            B = g.dataSeries.axisY, v = !1, h = new la(d, {
              x: 0,
              y: 0,
          ...
          h.measureText();
          g.dataSeries.indexLabelMaxWidth =
            h.maxWidth;
          if ("stackedarea100" === r) {
            if (g.point.x < c.x1 || g.point.x > c.x2 || g.point.y < c.y1 - 1 || g.point.y > c.y2 + 1) continue
          } else if ("rangearea" === r || "rangesplinearea" === r) {
            if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum) continue
          } else if (0 <= r.indexOf("line") || 0 <= r.indexOf("area") || 0 <= r.indexOf("bubble") || 0 <= r.indexOf("scatter")) {
            if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum ||
              g.dataPoint.y < B.viewportMinimum || g.dataPoint.y > B.viewportMaximum) continue
          } else if (0 <= r.indexOf("column") || "waterfall" === r || "error" === r && !g.axisSwapped) {
            if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.bounds.y1 > c.y2 || g.bounds.y2 < c.y1) continue
          } else if (0 <= r.indexOf("bar") || "error" === r) {
            if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.bounds.x1 > c.x2 || g.bounds.x2 < c.x1) continue
          } else if ("candlestick" === r || "ohlc" === r) {
            if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x >
              y.viewportMaximum || Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum) continue
          } else if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum) continue;
          e = n = 2;
          "horizontal" === x ? (m = h.width, A = h.height) : (A = h.width, m = h.height);
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== u ? (e = c.y1, f = c.y2, 0 < J ? (p = g.point.y - A - n - b, p < e && (p = "auto" === u ? Math.max(g.point.y, e) + n + b : e + n + b, v = p + A > g.point.y)) : (p = g.point.y + n + b, p > f - A - n - b && (p = "auto" === u ? Math.min(g.point.y, f) - A - n - b : f - A - n - b, v = p < g.point.y))) : (e = Math.max(g.bounds.y1, c.y1), f = Math.min(g.bounds.y2, c.y2), b = 0 <= r.indexOf("range") || "error" === r ? 0 < J ? Math.max(g.bounds.y1, c.y1) + A / 2 + n : Math.min(g.bounds.y2, c.y2) - A / 2 - n : (Math.max(g.bounds.y1, c.y1) + Math.min(g.bounds.y2, c.y2)) / 2, 0 < J ? (p = Math.max(g.point.y, b) - A / 2, p < e && ("bubble" === r || "scatter" ===
              r) && (p = Math.max(g.point.y - A - n, c.y1 + n))) : (p = Math.min(g.point.y, b) - A / 2, p > f - A - n && ("bubble" === r || "scatter" === r) && (p = Math.min(g.point.y + n, c.y2 - A - n))), p = Math.min(p, f - A))
          } else 0 <= r.indexOf("line") || 0 <= r.indexOf("area") || 0 <= r.indexOf("scatter") ? (u = "auto", e = 4) : 0 <= r.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === r && (u = "inside"), p = g.point.y - A / 2, "inside" !== u ? (n = c.x1, f = c.x2, 0 > J ? (q = g.point.x - m - e - b, q < n && (q = "auto" === u ? Math.max(g.point.x, n) + e + b : n + e + b, v = q + m > g.point.x)) : (q = g.point.x + e + b, q > f - m - e - b && (q = "auto" ===
          ...
          h.y = p;
          h.render(!0);
          l && ("inside" !== u && (0 > r.indexOf("bar") && ("error" !== r || !g.axisSwapped) && g.point.x > c.x1 && g.point.x < c.x2 ||
      ...
      for (a = 0; a < this._indexLabels.length; a++) g = this._indexLabels[a], h = ma("indexLabelBackgroundColor", g.dataPoint, g.dataSeries), g.dataSeries.indexLabelBackgroundColor = s(h) ? t ? "transparent" : null : h;
      return d
    };
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          var A = a.dataSeriesIndexes[m], g = this.data[A];
          c.lineWidth = g.lineThickness;
          var r = g.dataPoints, q = "solid";
          if (c.setLineDash) {
            var p = P(g.nullDataLineDashType, g.lineThickness), q = g.lineDashType, h = P(q, g.lineThickness);
            c.setLineDash(h)
          }
          var C = g.id;
          ...
          var C = g._colorSet, k = C = g.lineColor = g.options.lineColor ? g.options.lineColor : C[0];
          c.strokeStyle = C;
          var l = !0, u = 0, x, s;
          c.beginPath();
          if (0 < r.length) {
            for (var J = !1, u = 0; u < r.length; u++) if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J))) if ("number" !== typeof r[u].y) 0 < u && !(g.connectNullData || J || l) && (c.stroke(), t && b.stroke()), J = !0; else {
              x = a.axisX.convertValueToPixel(x);
              s =
                a.axisY.convertValueToPixel(r[u].y);
              var y = g.dataPointIds[u];
              ...
              l || J ? (!l && g.connectNullData ? (c.setLineDash && (g.options.nullDataLineDashType || q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(n.x, n.y), q = g.nullDataLineDashType, c.setLineDash(p)), c.lineTo(x, s), t && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), t && (b.beginPath(), b.moveTo(x, s))), J = l = !1) : (c.lineTo(x,
                s), t && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), t && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
              n = {x: x, y: s};
              u < r.length - 1 && (k !== (r[u].lineColor || C) || q !== (r[u].lineDashType || g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = r[u].lineColor || C, c.strokeStyle = k, c.setLineDash && (r[u].lineDashType ? (q = r[u].lineDashType, c.setLineDash(P(q, g.lineThickness))) : (q = g.lineDashType, c.setLineDash(h))));
              if (0 < r[u].markerSize || 0 < g.markerSize) {
                var B = g.getMarkerProperties(u, x, s, c);
                f.push(B);
                y = R(y);
                t && f.push({
                  x: x,
              ...
              (r[u].indexLabel || g.indexLabel || r[u].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                chartType: "line",
                dataPoint: r[u],
                dataSeries: g,
                point: {x: x, y: s},
        ...
        X.drawMarkers(f);
        t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
    ...
    l.prototype.renderStepLine = function (a) {
      var d = a.targetCanvasCtx ||
        this.plotArea.ctx, c = t ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          this._eventManager.objectMap[C] =
            {objectType: "dataSeries", dataSeriesIndex: A};
          C = R(C);
          b.strokeStyle = C;
          b.lineWidth = 0 < g.lineThickness ? Math.max(g.lineThickness, 4) : 0;
          var C = g._colorSet, k = C = g.lineColor = g.options.lineColor ? g.options.lineColor : C[0];
          ...
          c.beginPath();
          if (0 < r.length) {
            for (var J = !1, u = 0; u < r.length; u++) if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J))) if ("number" !== typeof r[u].y) 0 < u && !(g.connectNullData || J || l) && (c.stroke(),
            t && b.stroke()), J = !0; else {
              var y = s;
              x = a.axisX.convertValueToPixel(x);
              s = a.axisY.convertValueToPixel(r[u].y);
              var B = g.dataPointIds[u];
              ...
              l || J ? (!l && g.connectNullData ? (c.setLineDash && (g.options.nullDataLineDashType || q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(n.x, n.y), q = g.nullDataLineDashType, c.setLineDash(p)), c.lineTo(x, y), c.lineTo(x, s), t && (b.lineTo(x,
                y), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), t && (b.beginPath(), b.moveTo(x, s))), J = l = !1) : (c.lineTo(x, y), t && b.lineTo(x, y), c.lineTo(x, s), t && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), t && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
              n = {x: x, y: s};
              u < r.length - 1 && (k !== (r[u].lineColor || C) || q !== (r[u].lineDashType || g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = r[u].lineColor || C, c.strokeStyle = k, c.setLineDash && (r[u].lineDashType ? (q = r[u].lineDashType, c.setLineDash(P(q, g.lineThickness))) :
                (q = g.lineDashType, c.setLineDash(h))));
              if (0 < r[u].markerSize || 0 < g.markerSize) y = g.getMarkerProperties(u, x, s, c), f.push(y), B = R(B), t && f.push({
                x: x,
                y: s,
                ctx: b,
                type: y.type,
        ...
        c.beginPath();
        return {
          source: d, dest: this.plotArea.ctx, animationCallback: N.xClipAnimation,
    ...
    l.prototype.renderSpline = function (a) {
      function d(a) {
        ...
        if (0 < a.length) {
          ...
          0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), t && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
          b.stroke();
          t && e.stroke()
        }
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          C = R(C);
          e.strokeStyle = C;
          e.lineWidth = 0 < g.lineThickness ? Math.max(g.lineThickness, 4) : 0;
          var C = g._colorSet,
            k = C = g.lineColor = g.options.lineColor ? g.options.lineColor : C[0];
          b.strokeStyle = C;
          var l = 0, u, s, z = [];
          b.beginPath();
          if (0 < r.length) for (s = !1, l = 0; l < r.length; l++) if (u = r[l].getTime ? r[l].x.getTime() : r[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !s))) if ("number" !== typeof r[l].y) 0 < l && !s && (g.connectNullData ? b.setLineDash && (0 < z.length && (g.options.nullDataLineDashType || !r[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = p, q = g.nullDataLineDashType) : (d(z), z = [])), s = !0;
            ...
            z[z.length] = {x: u, y: s};
            l < r.length - 1 && (k !== (r[l].lineColor || C) || q !== (r[l].lineDashType || g.lineDashType)) && (k = r[l].lineColor || C, z[z.length - 1].newStrokeStyle = k, b.setLineDash && (r[l].lineDashType ? (q = r[l].lineDashType, z[z.length - 1].newLineDashArray = P(q, g.lineThickness)) : (q = g.lineDashType, z[z.length - 1].newLineDashArray =
              h)));
            if (0 < r[l].markerSize || 0 < g.markerSize) {
              var y = g.getMarkerProperties(l, u, s, b);
              n.push(y);
              J = R(J);
              t && n.push({
                x: u,
        ...
        X.drawMarkers(n);
        t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width,
    ...
    l.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null, e = this.plotArea, f = 0, n, m, A,
          ...
          r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width,
        ...
        !this.dataPointMaxWidth && (this.dataPointMinWidth && r < f) && (r = Math.max(this.options.dataPointWidth ?
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          var p = a.dataSeriesIndexes[r], h = this.data[p], C = h.dataPoints;
          if (0 < C.length) for (var k = 5 < q && h.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++) if (C[f].getTime ? A = C[f].x.getTime() :
            A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
            ...
            0 <= C[f].y ? u = g : (u = m, m = g);
            m > u && (b = m, m = u, u = b);
            b = C[f].color ? C[f].color : h._colorSet[f % h._colorSet.length];
            da(c, n, m, l, u, b, 0, null, k && 0 <= C[f].y,
              0 > C[f].y && k, !1, !1, h.fillOpacity);
            b = h.dataPointIds[f];
            this._eventManager.objectMap[b] = {
              id: b,
              objectType: "dataPoint",
            ...
            b = R(b);
            t && da(this._eventManager.ghostCtx, n, m, l, u, b, 0, null, !1, !1, !1, !1);
            (C[f].indexLabel || h.indexLabel || C[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
              chartType: "column",
              dataPoint: C[f],
              dataSeries: h,
              ...
              bounds: {
                x1: n,
                y1: Math.min(m, u), x2: l, y2: Math.max(m, u)
              },
              color: b
            })
          }
    ...
    l.prototype.renderStackedColumn = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null, e = this.plotArea, f = [], n = [], m = [], A = [], g = 0, r, q,
        ...
        this.dataPointMaxWidth && g > r && (g = Math.min(this.options.dataPointWidth ?
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            ...
            for (g = 0; g < u.length; g++) if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
              r = a.axisX.convertValueToPixel(b);
              var z = r - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, J = z + h << 0, y;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]),
                y = "undefined" !== typeof f[b] ? f[b] : p, f[b] = q); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = "undefined" !== typeof n[b] ? n[b] : p, n[b] = y; else if (q = a.axisY.convertValueToPixel(u[g].y), 0 <= u[g].y) {
                var B = "undefined" !== typeof f[b] ? f[b] : 0;
                q -= B;
                y = p - B;
                f[b] = B + (y - q)
              } else B = n[b] ? n[b] : 0, y = q + B, q = p + B, n[b] = B + (y - q);
              b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
              da(c, z, q, J, y, b, 0, null, s && 0 <= u[g].y, 0 > u[g].y && s, !1,
                !1, l.fillOpacity);
              b = l.dataPointIds[g];
              this._eventManager.objectMap[b] = {
                id: b,
              ...
              b = R(b);
              t && da(this._eventManager.ghostCtx, z, q, J, y, b, 0, null, !1, !1, !1, !1);
              (u[g].indexLabel || l.indexLabel || u[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                chartType: "stackedColumn",
                dataPoint: u[g],
                dataSeries: l,
                point: {x: r, y: 0 <= u[g].y ? q : y},
                direction: 0 > u[g].y === a.axisY.reversed ? 1 : -1,
                bounds: {
                  x1: z, y1: Math.min(q, y), x2: J, y2: Math.max(q,
                    y)
                },
                color: b
              })
    ...
    l.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null, e = this.plotArea, f = [], n = [], m = [], A = [], g = 0, r, q,
          p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
          g = this.options.dataPointMinWidth ? this.dataPointMinWidth :
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          var k = a.dataSeriesIndexes[C],
            l = this.data[k], u = l.dataPoints;
          if (0 < u.length) for (var s = 5 < h && l.bevelEnabled ? !0 : !1, g = 0; g < u.length; g++) if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
            r = a.axisX.convertValueToPixel(b);
            q = 0 !== a.dataPointYSums[b] ? 100 * (u[g].y / a.dataPointYSums[b]) : 0;
            var z = r - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, J = z + h << 0, y;
            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
              m[b] = q +
                ("undefined" !== typeof m[b] ? m[b] : 0);
              if (0 >= m[b]) continue;
              q = a.axisY.convertValueToPixel(m[b]);
              y = f[b] ? f[b] : p;
              f[b] = q
            } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = q + ("undefined" !== typeof A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = n[b] ? n[b] : p, n[b] = y; else if (q = a.axisY.convertValueToPixel(q), 0 <= u[g].y) {
              var B = "undefined" !== typeof f[b] ? f[b] : 0;
              q -= B;
              y = p - B;
              a.dataSeriesIndexes.length - 1 === C && 1 >= Math.abs(e.y1 - q) && (q = e.y1);
              f[b] = B + (y - q)
            } else B = "undefined" !== typeof n[b] ?
              n[b] : 0, y = q + B, q = p + B, a.dataSeriesIndexes.length - 1 === C && 1 >= Math.abs(e.y2 - y) && (y = e.y2), n[b] = B + (y - q);
            b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
            da(c, z, q, J, y, b, 0, null, s && 0 <= u[g].y, 0 > u[g].y && s, !1, !1, l.fillOpacity);
            b = l.dataPointIds[g];
            this._eventManager.objectMap[b] = {
              id: b,
              objectType: "dataPoint",
            ...
            b = R(b);
            t && da(this._eventManager.ghostCtx, z, q, J, y, b, 0, null, !1, !1, !1, !1);
            (u[g].indexLabel || l.indexLabel || u[g].indexLabelFormatter || l.indexLabelFormatter) &&
            this._indexLabels.push({
              ...
              point: {x: r, y: 0 <= u[g].y ? q : y},
              direction: 0 > u[g].y === a.axisY.reversed ? 1 : -1,
              bounds: {x1: z, y1: Math.min(q, y), x2: J, y2: Math.max(q, y)},
              color: b
            })
          }
        }
        t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
    ...
    l.prototype.renderBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b =
            null, e = this.plotArea, f = 0, n, m, A,
          g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
          f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < C.length) {
            ...
            for (f = 0; f < C.length; f++) if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
              ...
              0 <= C[f].y ? u = g : (u = n, n = g);
              b = C[f].color ? C[f].color : h._colorSet[f % h._colorSet.length];
              da(c, u, m, n, l, b, 0, null, k, !1, !1, !1, h.fillOpacity);
              b = h.dataPointIds[f];
              this._eventManager.objectMap[b] = {
                id: b,
                objectType: "dataPoint",
              ...
              b =
                R(b);
              t && da(this._eventManager.ghostCtx, u, m, n, l, b, 0, null, !1, !1, !1, !1);
              (C[f].indexLabel || h.indexLabel || C[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                chartType: "bar",
                dataPoint: C[f],
                dataSeries: h,
        ...
        return {
          ...
          easingFunction: N.easing.easeOutQuart,
          animationBase: g < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : g > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
            g
        }
      }
    };
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            var s = 5 < h && l.bevelEnabled ? !0 : !1;
            c.strokeStyle = "#4572A7 ";
            for (g = 0; g < u.length; g++) if (b = u[g].x.getTime ? u[g].x.getTime() :
              u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
              q = a.axisX.convertValueToPixel(b);
              var z = q - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, J = z + h << 0, y;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (y = f[b] ? f[b] : p, f[b] = r = a.axisY.convertValueToPixel(m[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), r = n[b] ?
                n[b] : p, n[b] = y = a.axisY.convertValueToPixel(A[b]); else if (r = a.axisY.convertValueToPixel(u[g].y), 0 <= u[g].y) {
                var B = f[b] ? f[b] : 0;
                y = p + B;
                r += B;
                f[b] = B + (r - y)
              ...
              b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
              da(c, y, z, r, J, b, 0, null, s, !1, !1, !1, l.fillOpacity);
              b = l.dataPointIds[g];
              this._eventManager.objectMap[b] = {
                id: b,
                objectType: "dataPoint",
              ...
              b = R(b);
              t && da(this._eventManager.ghostCtx, y, z, r, J, b, 0, null, !1, !1, !1,
                !1);
              (u[g].indexLabel || l.indexLabel || u[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                chartType: "stackedBar",
                dataPoint: u[g],
                dataSeries: l,
                point: {x: 0 <= u[g].y ? r : y, y: q},
                direction: 0 > u[g].y === a.axisY.reversed ? 1 : -1,
                bounds: {x1: Math.min(y, r), y1: z, x2: Math.max(y, r), y2: J},
                color: b
              })
            }
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            var s = 5 < h && l.bevelEnabled ? !0 : !1;
            c.strokeStyle = "#4572A7 ";
            for (g = 0; g < u.length; g++) if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
            "number" === typeof u[g].y) {
              q = a.axisX.convertValueToPixel(b);
              var z;
              z = 0 !== a.dataPointYSums[b] ? 100 * (u[g].y / a.dataPointYSums[b]) : 0;
              var J = q - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, y = J + h << 0;
              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
                m[b] = z + (m[b] ? m[b] : 0);
                if (0 >= m[b]) continue;
                z = f[b] ? f[b] : p;
                f[b] = r = a.axisY.convertValueToPixel(m[b])
              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = z + (A[b] ? A[b] : 0), r = n[b] ? n[b] :
                p, n[b] = z = a.axisY.convertValueToPixel(A[b]); else if (r = a.axisY.convertValueToPixel(z), 0 <= u[g].y) {
                var B = f[b] ? f[b] : 0;
                z = p + B;
                r += B;
              ...
              b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
              da(c, z, J, r, y, b, 0, null, s, !1, !1, !1, l.fillOpacity);
              b = l.dataPointIds[g];
              this._eventManager.objectMap[b] = {
                id: b, objectType: "dataPoint", dataSeriesIndex: k,
                dataPointIndex: g, x1: z, y1: J, x2: r, y2: y
              };
              b = R(b);
              t && da(this._eventManager.ghostCtx, z, J, r, y, b, 0, null, !1, !1, !1, !1);
              (u[g].indexLabel || l.indexLabel || u[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                chartType: "stackedBar100",
                dataPoint: u[g],
                dataSeries: l,
                point: {x: 0 <= u[g].y ? r : z, y: q},
                direction: 0 > u[g].y === a.axisY.reversed ? 1 : -1,
                bounds: {x1: Math.min(z, r), y1: J, x2: Math.max(z, r), y2: y},
                color: b
              })
            }
          }
        }
        t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop",
        ...
        return {
          ...
          animationCallback: N.xScaleAnimation,
          easingFunction: N.easing.easeOutQuart,
          animationBase: p < a.axisY.bounds.x1 ? a.axisY.bounds.x1 :
            p > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : p
        }
      }
    };
    l.prototype.renderArea = function (a) {
      ...
      function b() {
        y && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z), f.lineTo(l, J), f.lineTo(y.x, J), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(), n.fill()), f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {
          x: l,
          y: u
        })
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var n = this._eventManager.ghostCtx, m = a.axisY.lineCoordinates, A = [], g = this.plotArea, r;
        f.save();
        t && n.save();
        f.beginPath();
        f.rect(g.x1, g.y1, g.width, g.height);
        f.clip();
        t && (n.beginPath(), n.rect(g.x1, g.y1, g.width, g.height), n.clip());
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          var p = a.dataSeriesIndexes[q], h = this.data[p], C = h.dataPoints, A = h.id;
          this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: p};
          A = R(A);
          n.fillStyle = A;
          A = [];
          d = !0;
          var k = 0, l, u, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), J,
            y = null;
          if (0 < C.length) {
            var B = h._colorSet[k % h._colorSet.length], v = h.lineColor = h.options.lineColor || B, w = v;
            f.fillStyle = B;
            f.strokeStyle = v;
            f.lineWidth = h.lineThickness;
            c = "solid";
            if (f.setLineDash) {
              var L = P(h.nullDataLineDashType, h.lineThickness);
              c = h.lineDashType;
              var O = P(c, h.lineThickness);
              f.setLineDash(O)
            }
            for (var ha = !0; k < C.length; k++) if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin ||
              s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ha))) if ("number" !== typeof C[k].y) h.connectNullData || (ha || d) || b(), ha = !0; else {
              l = a.axisX.convertValueToPixel(s);
              u = a.axisY.convertValueToPixel(C[k].y);
              d || ha ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = r.x, u = r.y, b(), f.moveTo(r.x, r.y), l = d, u = c, y = r, c = h.nullDataLineDashType, f.setLineDash(L)), f.lineTo(l, u), t && n.lineTo(l, u)) : (f.beginPath(), f.moveTo(l, u), t &&
              (n.beginPath(), n.moveTo(l, u)), y = {
                x: l,
                y: u
              }), ha = d = !1) : (f.lineTo(l, u), t && n.lineTo(l, u), 0 == k % 250 && b());
              r = {x: l, y: u};
              k < C.length - 1 && (w !== (C[k].lineColor || v) || c !== (C[k].lineDashType || h.lineDashType)) && (b(), w = C[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (C[k].lineDashType ? (c = C[k].lineDashType, f.setLineDash(P(c, h.lineThickness))) : (c = h.lineDashType, f.setLineDash(O))));
              ...
              0 !== C[k].markerSize &&
              (0 < C[k].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(k, l, u, f), A.push(s), Z = R(Z), t && A.push({
                x: l,
                y: u,
                ctx: n,
                type: s.type,
              ...
              (C[k].indexLabel || h.indexLabel || C[k].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                chartType: "area",
                dataPoint: C[k],
                dataSeries: h,
                point: {x: l, y: u},
        ...
        t && (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
    ...
    l.prototype.renderSplineArea = function (a) {
      function d() {
        ...
        if (0 < c.length) {
          if (0 < r.lineThickness) {
            ...
            for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(),
          ...
          a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? l = k : 0 > a.axisY.viewportMaximum ?
            l = f.y1 : 0 < a.axisY.viewportMinimum && (l = k);
          u = {x: c[0].x, y: c[0].y};
      ...
      var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx : c;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = this._eventManager.ghostCtx, f = a.axisY.lineCoordinates, n = [], m = this.plotArea;
        b.save();
        t && e.save();
        b.beginPath();
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          var g = a.dataSeriesIndexes[A], r = this.data[g], q = r.dataPoints, n = r.id;
          this._eventManager.objectMap[n] = {objectType: "dataSeries", dataSeriesIndex: g};
          n = R(n);
          e.fillStyle = n;
          var n = [], p = 0, h, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            l, u = null, s = [];
          if (0 < q.length) {
            var z = r._colorSet[p % r._colorSet.length], J = r.lineColor = r.options.lineColor || z, y = J;
            b.fillStyle = z;
            b.strokeStyle =
              J;
            ...
            var B = "solid";
            if (b.setLineDash) {
              var w = P(r.nullDataLineDashType, r.lineThickness), B = r.lineDashType, D = P(B, r.lineThickness);
              b.setLineDash(D)
            }
            for (C = !1; p < q.length; p++) if (h = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C))) if ("number" !== typeof q[p].y) 0 < p && !C && (r.connectNullData ? b.setLineDash && (0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = w,
              B = r.nullDataLineDashType) : (d(), s = [])), C = !0; else {
              h = a.axisX.convertValueToPixel(h);
              C = a.axisY.convertValueToPixel(q[p].y);
              var L = r.dataPointIds[p];
              ...
              s[s.length] = {x: h, y: C};
              p < q.length - 1 && (y !== (q[p].lineColor || J) || B !== (q[p].lineDashType || r.lineDashType)) && (y = q[p].lineColor || J, s[s.length - 1].newStrokeStyle = y, b.setLineDash && (q[p].lineDashType ? (B = q[p].lineDashType, s[s.length - 1].newLineDashArray = P(B, r.lineThickness)) :
                (B = r.lineDashType, s[s.length - 1].newLineDashArray = D)));
              if (0 !== q[p].markerSize && (0 < q[p].markerSize || 0 < r.markerSize)) {
                var O = r.getMarkerProperties(p, h, C, b);
                n.push(O);
                L = R(L);
                t && n.push({
                  x: h,
    ...
    l.prototype.renderStepArea = function (a) {
      ...
      function b() {
        y && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z), f.lineTo(l, J), f.lineTo(y.x, J), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(), n.fill()),
          f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {x: l, y: u})
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        t && (n.beginPath(), n.rect(g.x1, g.y1, g.width, g.height), n.clip());
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          var p = a.dataSeriesIndexes[q], h = this.data[p], C = h.dataPoints,
            A = h.id;
          this._eventManager.objectMap[A] = {objectType: "dataSeries", dataSeriesIndex: p};
          A = R(A);
          n.fillStyle = A;
          ...
          if (0 < C.length) {
            ...
            var L = "solid";
            if (f.setLineDash) {
              var O = P(h.nullDataLineDashType, h.lineThickness), L = h.lineDashType, D = P(L, h.lineThickness);
              f.setLineDash(D)
            }
            for (; k <
                   C.length; k++) if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
              var Z = u;
              "number" !== typeof C[k].y ? (h.connectNullData || (c || d) || b(), c = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(C[k].y), d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || L === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = r.x, u = r.y, b(), f.moveTo(r.x, r.y), l = d, u = c, y = r, L = h.nullDataLineDashType,
                f.setLineDash(O)), f.lineTo(l, Z), f.lineTo(l, u), t && (n.lineTo(l, Z), n.lineTo(l, u))) : (f.beginPath(), f.moveTo(l, u), t && (n.beginPath(), n.moveTo(l, u)), y = {
                x: l,
                y: u
              }), c = d = !1) : (f.lineTo(l, Z), t && n.lineTo(l, Z), f.lineTo(l, u), t && n.lineTo(l, u), 0 == k % 250 && b()), r = {
                x: l,
                y: u
              }, k < C.length - 1 && (w !== (C[k].lineColor || v) || L !== (C[k].lineDashType || h.lineDashType)) && (b(), w = C[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (C[k].lineDashType ? (L = C[k].lineDashType, f.setLineDash(P(L, h.lineThickness))) : (L = h.lineDashType, f.setLineDash(D)))),
                s = h.dataPointIds[k], this._eventManager.objectMap[s] = {
                id: s,
                objectType: "dataPoint",
                dataSeriesIndex: p,
                dataPointIndex: k,
                x1: l,
                y1: u
              }, 0 !== C[k].markerSize && (0 < C[k].markerSize || 0 < h.markerSize) && (Z = h.getMarkerProperties(k, l, u, f), A.push(Z), s = R(s), t && A.push({
                x: l,
                y: u,
                ctx: n,
                type: Z.type,
                ...
                chartType: "stepArea", dataPoint: C[k], dataSeries: h, point: {
                  x: l,
                  y: u
                }, direction: 0 > C[k].y === a.axisY.reversed ? 1 : -1, color: B
              }))
            }
            b();
            X.drawMarkers(A)
    ...
    l.prototype.renderStackedArea = function (a) {
      function d() {
        if (!(1 > g.length)) {
          for (0 < B.lineThickness && b.stroke(); 0 < g.length;) {
            var a = g.pop();
            b.lineTo(a.x, a.y);
            t && s.lineTo(a.x, a.y)
          }
      ...
      var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx :
        c;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, f = null, n = [], m = this.plotArea, A = [], g = [], r = [], q = [], p = 0, h, k,
        ...
        for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
          var y = a.dataSeriesIndexes[J], B = this.data[y], v = B.dataPoints;
          B.dataPointIndexes =
            [];
        ...
        for (J = 0; J < a.dataSeriesIndexes.length; J++) {
          ...
          s.fillStyle = p;
          if (0 < r.length) {
            var e = B._colorSet[0], w = B.lineColor = B.options.lineColor || e, L = w;
            b.fillStyle = e;
            b.strokeStyle = w;
            ...
            if (b.setLineDash) {
              var O =
                P(B.nullDataLineDashType, B.lineThickness);
              z = B.lineDashType;
              var D = P(z, B.lineThickness);
              b.setLineDash(D)
            }
            for (var Z = !0, p = 0; p < r.length; p++) {
              var f = r[p], ia = null, ia = 0 <= B.dataPointIndexes[f] ? v[B.dataPointIndexes[f]] : {x: f, y: null};
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z))) if ("number" !== typeof ia.y) B.connectNullData || (Z || x) || d(), Z = !0; else {
                ...
                g.push({x: h, y: l - na});
                A[f] = l - k;
                x || Z ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = g.pop(), z = g[g.length - 1], d(), b.moveTo(u.x, u.y), g.push(z), g.push(x), z = B.nullDataLineDashType, b.setLineDash(O)), b.lineTo(h, k), t && s.lineTo(h, k)) : (b.beginPath(), b.moveTo(h, k), t && (s.beginPath(),
                  s.moveTo(h, k))), Z = x = !1) : (b.lineTo(h, k), t && s.lineTo(h, k), 0 == p % 250 && (d(), b.moveTo(h, k), t && s.moveTo(h, k), g.push({
                  x: h,
                  y: l - na
                })));
                u = {x: h, y: k};
                p < v.length - 1 && (L !== (v[p].lineColor || w) || z !== (v[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, k), g.push({
                  x: h,
                  y: l - na
                }), L = v[p].lineColor || w, b.strokeStyle = L, b.setLineDash && (v[p].lineDashType ? (z = v[p].lineDashType, b.setLineDash(P(z, B.lineThickness))) : (z = B.lineDashType, b.setLineDash(D))));
                ...
                0 <= B.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (na = B.getMarkerProperties(B.dataPointIndexes[f], h, k, b), n.push(na), f = R(E), t && n.push({
                  x: h,
                  y: k,
                  ctx: s,
                  type: na.type,
                ...
                (ia.indexLabel || B.indexLabel || ia.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
    ...
    l.prototype.renderStackedArea100 = function (a) {
      ...
      var c = a.targetCanvasCtx || this.plotArea.ctx, b = t ? this._preRenderCtx : c;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, f = null, n = this.plotArea, m = [], k = [], g = [], r = [], q = [], p = 0, h, l, s, aa, u,
        ...
        for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
          var y = a.dataSeriesIndexes[v],
            B = this.data[y], w = B.dataPoints;
          B.dataPointIndexes = [];
          for (p = 0; p < w.length; p++) y = w[p].x.getTime ? w[p].x.getTime() : w[p].x, B.dataPointIndexes[y] = p, e[y] || (r.push(y), e[y] = !0);
          r.sort(Pa)
        }
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          g = [];
          if (0 < r.length) {
            var e = B._colorSet[p % B._colorSet.length], D = B.lineColor = B.options.lineColor || e, L = D;
            b.fillStyle = e;
            b.strokeStyle =
              D;
            b.lineWidth = B.lineThickness;
            u = "solid";
            if (b.setLineDash) {
              var O = P(B.nullDataLineDashType, B.lineThickness);
              u = B.lineDashType;
              var E = P(u, B.lineThickness);
              b.setLineDash(E)
            }
            for (var Z = !0, p = 0; p < r.length; p++) {
              var f = r[p], ia = null, ia = 0 <= B.dataPointIndexes[f] ? w[B.dataPointIndexes[f]] : {x: f, y: null};
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z))) if ("number" !== typeof ia.y) B.connectNullData || (Z || aa) || d(), Z = !0; else {
                var na;
                ...
                } else l = a.axisY.convertValueToPixel(na), l -= ca;
                g.push({x: h, y: x - ca});
                k[f] = x - l;
                aa || Z ? (!aa && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (aa = g.pop(), u = g[g.length - 1], d(), b.moveTo(s.x,
                  s.y), g.push(u), g.push(aa), u = B.nullDataLineDashType, b.setLineDash(O)), b.lineTo(h, l), t && z.lineTo(h, l)) : (b.beginPath(), b.moveTo(h, l), t && (z.beginPath(), z.moveTo(h, l))), Z = aa = !1) : (b.lineTo(h, l), t && z.lineTo(h, l), 0 == p % 250 && (d(), b.moveTo(h, l), t && z.moveTo(h, l), g.push({
                  x: h,
                  y: x - ca
                })));
                s = {x: h, y: l};
                p < w.length - 1 && (L !== (w[p].lineColor || D) || u !== (w[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, l), g.push({
                  x: h,
                  y: x - ca
                }), L = w[p].lineColor || D, b.strokeStyle = L, b.setLineDash && (w[p].lineDashType ? (u = w[p].lineDashType,
                  b.setLineDash(P(u, B.lineThickness))) : (u = B.lineDashType, b.setLineDash(E))));
                if (0 <= B.dataPointIndexes[f]) {
                ...
                0 <= B.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (ca = B.getMarkerProperties(p, h, l, b), m.push(ca), f = R(F), t && m.push({
                  x: h,
                  y: l,
                  ctx: z,
                  type: ca.type,
        ...
        b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(n.x1, n.y1, n.width, n.height), z.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
    ...
    l.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = -Infinity, k = Infinity, g = 0; g < a.dataSeriesIndexes.length; g++) for (var r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints, h = 0, e = 0; e < p.length; e++) f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
        "undefined" === typeof p[e].z || (h = p[e].z, h > m && (m = h), h < k && (k = h));
        for (var l = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), g = 0; g < a.dataSeriesIndexes.length; g++) if (r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints, 0 < p.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < p.length; e++) if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
          ...
          var h = p[e].z,
            aa = 2 * Math.max(Math.sqrt((m === k ? s / 2 : l + (s - l) / (m - k) * (h - k)) / Math.PI) << 0, 1),
            h = q.getMarkerProperties(e, c);
          h.size = aa;
          c.globalAlpha = q.fillOpacity;
          X.drawMarker(f, n, c, h.type, h.size, h.color, h.borderColor, h.borderThickness);
          c.globalAlpha = 1;
          ...
          aa = R(u);
          t && X.drawMarker(f, n, this._eventManager.ghostCtx, h.type, h.size, aa, aa, h.borderThickness);
          (p[e].indexLabel || q.indexLabel ||
            p[e].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
            chartType: "bubble",
            dataPoint: p[e],
            dataSeries: q,
            point: {x: f, y: n},
            direction: 1,
            bounds: {x1: f - h.size / 2, y1: n - h.size / 2, x2: f + h.size / 2, y2: n + h.size / 2},
            color: null
          })
        }
        t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
    ...
    l.prototype.renderScatter = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var k = a.dataSeriesIndexes[m], g = this.data[k], r = g.dataPoints;
          if (0 < r.length) {
            c.strokeStyle = "#4572A7 ";
            Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2);
            for (var q = 0, p = 0, e = 0; e < r.length; e++) if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
              f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
              f = a.axisX.convertValueToPixel(f);
              n = a.axisY.convertValueToPixel(r[e].y);
              var h = g.getMarkerProperties(e, f, n, c);
              c.globalAlpha = g.fillOpacity;
              X.drawMarker(h.x, h.y, h.ctx, h.type, h.size, h.color, h.borderColor, h.borderThickness);
              c.globalAlpha = 1;
              Math.sqrt((q - f) * (q - f) + (p - n) * (p - n)) < Math.min(h.size, 5) && r.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = g.dataPointIds[e], this._eventManager.objectMap[q] = {
                id: q, objectType: "dataPoint", dataSeriesIndex: k,
                dataPointIndex: e, x1: f, y1: n
              }, q = R(q), t && X.drawMarker(h.x, h.y, this._eventManager.ghostCtx, h.type, h.size, q, q, h.borderThickness), (r[e].indexLabel || g.indexLabel || r[e].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                chartType: "scatter",
                dataPoint: r[e],
                dataSeries: g,
                point: {x: f, y: n},
      ...
      function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          l = this.options.dataPointWidth ?
            this.dataPointWidth : 0.7 * n.width * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) << 0;
          ...
          c.clip();
          t && (b.beginPath(), b.rect(n.x1, n.y1, n.width,
            n.height), b.clip());
          for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
            var aa = a.dataSeriesIndexes[ga], u = this.data[aa], x = u.dataPoints;
            if (0 < x.length) for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++) if (x[m].getTime ? h = x[m].x.getTime() : h = x[m].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] && "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3]) {
              k = a.axisX.convertValueToPixel(h);
              g = a.axisY.convertValueToPixel(x[m].y[0]);
              r = a.axisY.convertValueToPixel(x[m].y[1]);
              q = a.axisY.convertValueToPixel(x[m].y[2]);
              p = a.axisY.convertValueToPixel(x[m].y[3]);
              var v = k - l / 2 << 0, y = v + l << 0, f = u.options.fallingColor ? u.fallingColor : u._colorSet[0],
                e = x[m].color ? x[m].color : u._colorSet[0], B = Math.round(Math.max(1, 0.15 * l)),
                w = 0 === B % 2 ? 0 : 0.5, D = u.dataPointIds[m];
              ...
              "candlestick" === u.type ? (c.moveTo(k - w, r), c.lineTo(k - w, Math.min(g, p)), c.stroke(), c.moveTo(k - w, Math.max(g, p)), c.lineTo(k - w, q), c.stroke(), da(c, v, Math.min(g, p), y, Math.max(g, p), x[m].y[0] <= x[m].y[3] ? u.risingColor : f, B, e, z, z, !1, !1, u.fillOpacity), t && (e = R(D), b.strokeStyle = e, b.moveTo(k - w, r), b.lineTo(k - w, Math.min(g, p)), b.stroke(), b.moveTo(k - w, Math.max(g, p)), b.lineTo(k - w, q), b.stroke(), da(b, v, Math.min(g, p), y, Math.max(g, p), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(k -
                w, r), c.lineTo(k - w, q), c.stroke(), c.beginPath(), c.moveTo(k, g), c.lineTo(v, g), c.stroke(), c.beginPath(), c.moveTo(k, p), c.lineTo(y, p), c.stroke(), t && (e = R(D), b.strokeStyle = e, b.moveTo(k - w, r), b.lineTo(k - w, q), b.stroke(), b.beginPath(), b.moveTo(k, g), b.lineTo(v, g), b.stroke(), b.beginPath(), b.moveTo(k, p), b.lineTo(y, p), b.stroke()));
              (x[m].indexLabel || u.indexLabel || x[m].indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                chartType: u.type, dataPoint: x[m], dataSeries: u, point: {
                  x: v + (y - v) / 2, y: a.axisY.reversed ?
                    q : r
                }, direction: 1, bounds: {x1: v, y1: Math.min(r, q), x2: y, y2: Math.max(r, q)}, color: e
              })
            }
          }
    ...
    l.prototype.renderBoxAndWhisker = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d, b = this._eventManager.ghostCtx;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, f = this.plotArea, n = 0, m, k, g, r, q, p, h,
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
        ...
        !this.dataPointMaxWidth && (this.dataPointMinWidth && n < e) && (n = Math.max(this.options.dataPointWidth ?
        ...
        for (var ga = !1, ga = !!a.axisY.reversed, aa = 0; aa < a.dataSeriesIndexes.length; aa++) {
          var u = a.dataSeriesIndexes[aa], x = this.data[u], z = x.dataPoints;
          if (0 < z.length) for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++) if (z[n].getTime ? h = z[n].x.getTime() : h = z[n].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) &&
          !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
            m = a.axisX.convertValueToPixel(h);
            k = a.axisY.convertValueToPixel(z[n].y[0]);
            g = a.axisY.convertValueToPixel(z[n].y[1]);
            ...
            var y = m - l / 2 << 0, B = m + l / 2 << 0, e = z[n].color ? z[n].color : x._colorSet[0],
              w = Math.round(Math.max(1,
                0.15 * l)), D = 0 === w % 2 ? 0 : 0.5,
              L = z[n].whiskerColor ? z[n].whiskerColor : z[n].color ? x.whiskerColor ? x.whiskerColor : z[n].color : x.whiskerColor ? x.whiskerColor : e,
              O = "number" === typeof z[n].whiskerThickness ? z[n].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : w,
              E = z[n].whiskerDashType ? z[n].whiskerDashType : x.whiskerDashType,
              Z = s(z[n].whiskerLength) ? s(x.options.whiskerLength) ? l : x.whiskerLength : z[n].whiskerLength,
              Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= l ? l : Z : "string" === typeof Z ? parseInt(Z) * l / 100 >
              l ? l : parseInt(Z) * l / 100 : l, ia = 1 === Math.round(O) % 2 ? 0.5 : 0,
              na = z[n].stemColor ? z[n].stemColor : z[n].color ? x.stemColor ? x.stemColor : z[n].color : x.stemColor ? x.stemColor : e,
              ca = "number" === typeof z[n].stemThickness ? z[n].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : w,
              F = 1 === Math.round(ca) % 2 ? 0.5 : 0, I = z[n].stemDashType ? z[n].stemDashType : x.stemDashType,
              G = z[n].lineColor ? z[n].lineColor : z[n].color ? x.lineColor ? x.lineColor : z[n].color : x.lineColor ? x.lineColor : e,
              M = "number" === typeof z[n].lineThickness ?
                z[n].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : w,
              S = z[n].lineDashType ? z[n].lineDashType : x.lineDashType, K = 1 === Math.round(M) % 2 ? 0.5 : 0,
              V = x.upperBoxColor, xa = x.lowerBoxColor, sa = s(x.options.fillOpacity) ? 1 : x.fillOpacity,
              Q = x.dataPointIds[n];
            ...
            c.save();
            0 < ca && (c.beginPath(), c.strokeStyle = na, c.lineWidth = ca, c.setLineDash && c.setLineDash(P(I, ca)), c.moveTo(m - F, g), c.lineTo(m - F, k), c.stroke(), c.moveTo(m - F, q), c.lineTo(m - F, r), c.stroke());
            c.restore();
            b.lineWidth = Math.max(w, 4);
            c.beginPath();
            da(c, y, Math.min(p, g), B, Math.max(g, p), xa, 0, e, ga ? v : !1, ga ? !1 : v, !1, !1, sa);
            c.beginPath();
            da(c, y, Math.min(r, p), B, Math.max(p, r), V, 0, e, ga ? !1 : v, ga ? v : !1, !1, !1, sa);
            c.beginPath();
            c.lineWidth = w;
            c.strokeStyle = e;
            c.rect(y - D, Math.min(g, r) - D, B - y + 2 * D, Math.max(g,
              r) - Math.min(g, r) + 2 * D);
            c.stroke();
            c.save();
            0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(P(S, M)), c.strokeStyle = G, c.lineWidth = M, c.moveTo(y, p - K), c.lineTo(B, p - K), c.stroke());
            c.restore();
            c.save();
            0 < O && (c.beginPath(), c.setLineDash && c.setLineDash(P(E, O)), c.strokeStyle = L, c.lineWidth = O, c.moveTo(m - Z / 2 << 0, q - ia), c.lineTo(m + Z / 2 << 0, q - ia), c.stroke(), c.moveTo(m - Z / 2 << 0, k + ia), c.lineTo(m + Z / 2 << 0, k + ia), c.stroke());
            c.restore();
            t && (e = R(Q), b.strokeStyle = e, b.lineWidth = ca, 0 < ca && (b.moveTo(m - D - F, g), b.lineTo(m -
              D - F, Math.max(k, q)), b.stroke(), b.moveTo(m - D - F, Math.min(k, q)), b.lineTo(m - D - F, r), b.stroke()), da(b, y, Math.max(g, r), B, Math.min(g, r), e, 0, null, !1, !1, !1, !1), 0 < O && (b.beginPath(), b.lineWidth = O, b.moveTo(m + Z / 2, q - ia), b.lineTo(m - Z / 2, q - ia), b.stroke(), b.moveTo(m + Z / 2, k + ia), b.lineTo(m - Z / 2, k + ia), b.stroke()));
            (z[n].indexLabel || x.indexLabel || z[n].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
              ...
              bounds: {
                x1: y,
                y1: Math.min(k, q), x2: B, y2: Math.max(k, q)
              },
              color: e
            })
          }
    ...
    l.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        g = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(g) / Math.log(a.axisX.range) : Math.abs(g) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
        this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        !this.dataPointMaxWidth && (this.dataPointMinWidth && n < f) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity,
          f));
        g < f && (g = f);
        g > n && (g = n);
        c.save();
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          var q = a.dataSeriesIndexes[r], p = this.data[q], h = p.dataPoints;
          if (0 < h.length) for (var l = 5 < g && p.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++) if (h[f].getTime ? k = h[f].x.getTime() : k = h[f].x, !(k < a.axisX.dataInfo.viewPortMin ||
            k > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
            b = a.axisX.convertValueToPixel(k);
            n = a.axisY.convertValueToPixel(h[f].y[0]);
            m = a.axisY.convertValueToPixel(h[f].y[1]);
            var ga = a.axisX.reversed ? b + a.plotType.totalDataSeries * g / 2 - (a.previousDataSeriesCount + r) * g << 0 : b - a.plotType.totalDataSeries * g / 2 + (a.previousDataSeriesCount + r) * g << 0,
              aa = a.axisX.reversed ? ga - g << 0 : ga + g << 0,
              b = h[f].color ? h[f].color : p._colorSet[f % p._colorSet.length];
            if (n > m) {
              var u =
                n;
              n = m;
            ...
            da(c, ga, n, aa, m, b, 0, b, l, l, !1, !1, p.fillOpacity);
            b = R(u);
            t && da(this._eventManager.ghostCtx, ga, n, aa, m, b, 0, null, !1, !1, !1, !1);
            if (h[f].indexLabel || p.indexLabel || h[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
              chartType: "rangeColumn",
              dataPoint: h[f],
              dataSeries: p,
              indexKeyword: 0,
              point: {x: ga + (aa - ga) / 2, y: h[f].y[1] >= h[f].y[0] ? m : n},
              direction: h[f].y[1] >=
              h[f].y[0] ? -1 : 1,
              bounds: {x1: ga, y1: Math.min(n, m), x2: aa, y2: Math.max(n, m)},
              color: b
            }), this._indexLabels.push({
              chartType: "rangeColumn",
              dataPoint: h[f],
              dataSeries: p,
              indexKeyword: 1,
              point: {x: ga + (aa - ga) / 2, y: h[f].y[1] >= h[f].y[0] ? n : m},
    ...
    l.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var e = null, f = !1, n = this.plotArea, m = 0, k, g, r, q, p, h, l, ga = a.axisX.dataInfo.minDiff;
        ...
        for (var aa =
          0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && aa || aa++;
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var z = a.dataSeriesIndexes[x], v = this.data[z], y = v.dataPoints,
            B = s(v._linkedSeries) ? !1 : v._linkedSeries.type.match(/(bar|column)/ig) && v._linkedSeries.visible ? !0 : !1,
            D = 0;
          if (B) for (e = v._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) &&
          D || (this.data[u].type.match(/(range)/ig) && (f = !0), D++);
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
          m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? aa : 1))) << 0 : 0.3 * this.width;
          f && (m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height /
            (B ? aa : 1))) << 0 : 0.03 * this.width);
          u = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? n.height : n.width) * (a.axisX.logarithmic ? Math.log(ga) / Math.log(a.axisX.range) : Math.abs(ga) / Math.abs(a.axisX.range)) / (B ? aa : 1)) << 0;
          ...
          u < e && (u = e);
          u > m && (u = m);
          if (0 < y.length) for (var E = v._colorSet,
                                   m = 0; m < y.length; m++) {
            var e = v.lineColor = v.options.color ? v.options.color : E[0], L = {
              color: y[m].whiskerColor ? y[m].whiskerColor : y[m].color ? v.whiskerColor ? v.whiskerColor : y[m].color : v.whiskerColor ? v.whiskerColor : e,
              thickness: s(y[m].whiskerThickness) ? v.whiskerThickness : y[m].whiskerThickness,
              dashType: y[m].whiskerDashType ? y[m].whiskerDashType : v.whiskerDashType,
              length: s(y[m].whiskerLength) ? s(v.options.whiskerLength) ? u : v.options.whiskerLength : y[m].whiskerLength,
              trimLength: s(y[m].whiskerLength) ? s(v.options.whiskerLength) ?
                50 : 0 : 0
            };
            ...
            var O = {
              color: y[m].stemColor ? y[m].stemColor : y[m].color ? v.stemColor ? v.stemColor : y[m].color : v.stemColor ? v.stemColor : e,
              thickness: y[m].stemThickness ? y[m].stemThickness : v.stemThickness,
              dashType: y[m].stemDashType ? y[m].stemDashType : v.stemDashType
            };
            O.thickness =
              "number" === typeof O.thickness ? 0 > O.thickness ? 0 : Math.round(O.thickness) : 2;
            ...
            if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !s(y[m].y) && y[m].y.length && "number" === typeof y[m].y[0] && "number" === typeof y[m].y[1]) {
              var ha = a.axisX.convertValueToPixel(l);
              b ? g = ha : k = ha;
              ha = a.axisY.convertValueToPixel(y[m].y[0]);
              b ? r = ha : p = ha;
              ha = a.axisY.convertValueToPixel(y[m].y[1]);
              b ? q = ha : h = ha;
              b ? (p = a.axisX.reversed ? g + (B ? aa : 1) * u / 2 - (B ? D - 1 : 0) * u << 0 : g - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) *
                u << 0, h = a.axisX.reversed ? p - u << 0 : p + u << 0) : (r = a.axisX.reversed ? k + (B ? aa : 1) * u / 2 - (B ? D - 1 : 0) * u << 0 : k - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) * u << 0, q = a.axisX.reversed ? r - u << 0 : r + u << 0);
              !b && p > h && (ha = p, p = h, h = ha);
              b && r > q && (ha = r, r = q, q = ha);
              ha = v.dataPointIds[m];
              ...
              w(c, Math.min(r, q), Math.min(p, h), Math.max(q, r), Math.max(h, p),
                e, L, O, b);
              t && w(this._eventManager.ghostCtx, r, p, q, h, e, L, O, b);
              if (y[m].indexLabel || v.indexLabel || y[m].indexLabelFormatter || v.indexLabelFormatter) this._indexLabels.push({
                chartType: "error",
                dataPoint: y[m],
                dataSeries: v,
                indexKeyword: 0,
                point: {
                  ...
                  y: b ? p + (h - p) / 2 : y[m].y[1] >= y[m].y[0] ? h : p
                },
                ...
                point: {
                  ...
                  y: b ? p + (h - p) / 2 : y[m].y[1] >= y[m].y[0] ? p : h
                },
                direction: y[m].y[1] >= y[m].y[0] ? 1 : -1,
                bounds: {
                  x1: b ? Math.min(r, q) : r,
        ...
        t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas,
          0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(n.x1, n.y1, n.width, n.height), this._eventManager.ghostCtx.restore());
        c.restore();
        return {
          source: d,
          dest: this.plotArea.ctx,
    ...
    l.prototype.renderRangeBar = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        r = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.height * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) :
          Math.abs(r) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
        this.dataPointMaxWidth && f > n && (f = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n));
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          var p = a.dataSeriesIndexes[q], h = this.data[p], l = h.dataPoints;
          if (0 < l.length) {
            var ga = 5 < r && h.bevelEnabled ? !0 : !1;
            c.strokeStyle = "#4572A7 ";
            for (f = 0; f < l.length; f++) if (l[f].getTime ? g = l[f].x.getTime() : g = l[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(l[f].y) && l[f].y.length && "number" === typeof l[f].y[0] && "number" === typeof l[f].y[1]) {
              ...
              n > m && (b = n, n = m, m = b);
              b = l[f].color ? l[f].color : h._colorSet[f % h._colorSet.length];
              da(c, n, k, m, v, b, 0, null, ga, !1, !1, !1, h.fillOpacity);
              b = h.dataPointIds[f];
              this._eventManager.objectMap[b] = {
                id: b,
                objectType: "dataPoint",
              ...
              b = R(b);
              t && da(this._eventManager.ghostCtx,
                n, k, m, v, b, 0, null, !1, !1, !1, !1);
              if (l[f].indexLabel || h.indexLabel || l[f].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
                chartType: "rangeBar",
                dataPoint: l[f],
                dataSeries: h,
                indexKeyword: 0,
                ...
                dataSeries: h,
                indexKeyword: 1,
                point: {x: l[f].y[1] >= l[f].y[0] ? m : n, y: k + (v - k) / 2},
                direction: l[f].y[1] >=
                l[f].y[0] ? 1 : -1,
                bounds: {x1: Math.min(n, m), y1: k, x2: Math.max(n, m), y2: v},
                color: b
    ...
    l.prototype.renderRangeArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var k = [], g = a.dataSeriesIndexes[m], r = this.data[g], q = r.dataPoints, f = r.id;
          this._eventManager.objectMap[f] =
            {objectType: "dataSeries", dataSeriesIndex: g};
          f = R(f);
          e.fillStyle = f;
          var f = [], p = !0, h = 0, l, s, v, u, x = null;
          if (0 < q.length) {
            var z = r._colorSet[h % r._colorSet.length], w = r.lineColor = r.options.lineColor || z, y = w;
            b.fillStyle = z;
            b.strokeStyle = w;
            b.lineWidth = r.lineThickness;
            var B = "solid";
            if (b.setLineDash) {
              var D = P(r.nullDataLineDashType, r.lineThickness), B = r.lineDashType, E = P(B, r.lineThickness);
              b.setLineDash(E)
            }
            for (var L = !0; h < q.length; h++) if (u = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax &&
              (!r.connectNullData || !L))) if (null !== q[h].y && q[h].y.length && "number" === typeof q[h].y[0] && "number" === typeof q[h].y[1]) {
              l = a.axisX.convertValueToPixel(u);
              s = a.axisY.convertValueToPixel(q[h].y[0]);
              v = a.axisY.convertValueToPixel(q[h].y[1]);
              p || L ? (r.connectNullData && !p ? (b.setLineDash && (r.options.nullDataLineDashType || B === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = E, B = r.nullDataLineDashType, b.setLineDash(D)), b.lineTo(l, s), t && e.lineTo(l, s), k.push({
                x: l,
                y: v
              })) : (b.beginPath(),
                b.moveTo(l, s), x = {x: l, y: s}, k = [], k.push({
                x: l,
                y: v
              }), t && (e.beginPath(), e.moveTo(l, s))), L = p = !1) : (b.lineTo(l, s), k.push({
                x: l,
                y: v
              }), t && e.lineTo(l, s), 0 == h % 250 && d());
              u = r.dataPointIds[h];
              this._eventManager.objectMap[u] = {
                id: u,
                objectType: "dataPoint",
              ...
              h < q.length - 1 && (y !== (q[h].lineColor || w) || B !== (q[h].lineDashType || r.lineDashType)) && (d(), y = q[h].lineColor || w, k[k.length - 1].newStrokeStyle = y, b.strokeStyle = y, b.setLineDash && (q[h].lineDashType ? (B = q[h].lineDashType, k[k.length -
              1].newLineDashArray = P(B, r.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (B = r.lineDashType, k[k.length - 1].newLineDashArray = E, b.setLineDash(E))));
              if (0 !== q[h].markerSize && (0 < q[h].markerSize || 0 < r.markerSize)) {
                var O = r.getMarkerProperties(h, l, v, b);
                f.push(O);
                var ha = R(u);
                t && f.push({
                  x: l,
                ...
                O = r.getMarkerProperties(h, l, s, b);
                f.push(O);
                ha = R(u);
                t && f.push({
                  x: l, y: s, ctx: e, type: O.type, size: O.size, color: ha, borderColor: ha,
                  borderThickness: O.borderThickness
                })
              }
              if (q[h].indexLabel || r.indexLabel || q[h].indexLabelFormatter || r.indexLabelFormatter) this._indexLabels.push({
                chartType: "rangeArea",
                dataPoint: q[h],
                dataSeries: r,
                indexKeyword: 0,
                point: {x: l, y: s},
                direction: q[h].y[0] > q[h].y[1] === a.axisY.reversed ? -1 : 1,
                color: z
              }), this._indexLabels.push({
                chartType: "rangeArea",
                dataPoint: q[h],
        ...
        b.restore();
        return {
          source: c, dest: this.plotArea.ctx, animationCallback: N.xClipAnimation,
          easingFunction: N.easing.linear, animationBase: 0
        }
      }
    };
    l.prototype.renderRangeSplineArea = function (a) {
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          d = v(aa, 2);
          b.lineTo(aa[aa.length - 1].x, aa[aa.length - 1].y);
          for (f = d.length - 1; 2 < f; f -= 3) b.bezierCurveTo(d[f - 1].x, d[f - 1].y, d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y), t && e.bezierCurveTo(d[f - 1].x, d[f - 1].y,
            d[f - 2].x, d[f - 2].y, d[f - 3].x, d[f - 3].y);
          b.closePath();
          b.globalAlpha = g.fillOpacity;
          b.fill();
          ...
          if (0 < g.lineThickness) {
            ...
            for (var h = f = 0; f < d.length - 3; f += 3, h++) {
              if (s[h].newStrokeStyle || s[h].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), s[h].newStrokeStyle && (b.strokeStyle = s[h].newStrokeStyle), s[h].newLineDashArray && b.setLineDash(s[h].newLineDashArray);
              b.bezierCurveTo(d[f +
              1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
            }
            b.stroke()
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        t && (e.beginPath(), e.rect(n.x1, n.y1, n.width, n.height), e.clip());
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var k = a.dataSeriesIndexes[m], g = this.data[k], r = g.dataPoints, f = g.id;
          this._eventManager.objectMap[f] =
            {objectType: "dataSeries", dataSeriesIndex: k};
          f = R(f);
          e.fillStyle = f;
          var f = [], q = 0, p, h, l, s = [], aa = [];
          if (0 < r.length) {
            var u = g._colorSet[q % g._colorSet.length], x = g.lineColor = g.options.lineColor || u, z = x;
            b.fillStyle = u;
            b.lineWidth = g.lineThickness;
            var w = "solid", y;
            if (b.setLineDash) {
              var B = P(g.nullDataLineDashType, g.lineThickness), w = g.lineDashType;
              y = P(w, g.lineThickness)
            }
            for (h = !1; q < r.length; q++) if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!g.connectNullData ||
              !h))) if (null !== r[q].y && r[q].y.length && "number" === typeof r[q].y[0] && "number" === typeof r[q].y[1]) {
              p = a.axisX.convertValueToPixel(p);
              h = a.axisY.convertValueToPixel(r[q].y[0]);
              l = a.axisY.convertValueToPixel(r[q].y[1]);
              var D = g.dataPointIds[q];
              this._eventManager.objectMap[D] = {
                id: D,
                objectType: "dataPoint",
                dataSeriesIndex: k,
              ...
              s[s.length] = {x: p, y: h};
              aa[aa.length] = {x: p, y: l};
              q < r.length - 1 && (z !== (r[q].lineColor || x) || w !== (r[q].lineDashType || g.lineDashType)) && (z = r[q].lineColor || x, s[s.length -
              1].newStrokeStyle = z, b.setLineDash && (r[q].lineDashType ? (w = r[q].lineDashType, s[s.length - 1].newLineDashArray = P(w, g.lineThickness)) : (w = g.lineDashType, s[s.length - 1].newLineDashArray = y)));
              if (0 !== r[q].markerSize && (0 < r[q].markerSize || 0 < g.markerSize)) {
                var E = g.getMarkerProperties(q, p, h, b);
                f.push(E);
                var L = R(D);
                t && f.push({
                  x: p,
                ...
                E = g.getMarkerProperties(q, p, l, b);
                f.push(E);
                L = R(D);
                t && f.push({
                  x: p, y: l, ctx: e, type: E.type, size: E.size,
                  color: L, borderColor: L, borderThickness: E.borderThickness
                })
              }
              if (r[q].indexLabel || g.indexLabel || r[q].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({
              ...
              h = !1
            } else 0 < q && !h && (g.connectNullData ? b.setLineDash &&
              (0 < s.length && (g.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = B, w = g.nullDataLineDashType) : (d(y, x), s = [], aa = [])), h = !0;
            d(y, x);
            X.drawMarkers(f)
          }
        }
        t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
          0, 0, this.width, this.height), b.clearRect(n.x1, n.y1, n.width, n.height), this._eventManager.ghostCtx.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
    ...
    l.prototype.renderWaterfall = function (a) {
      var d = a.targetCanvasCtx || this.plotArea.ctx, c = t ? this._preRenderCtx : d;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, n = 0, m, k, g, r,
          q = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
        ...
        p = this.options.dataPointWidth ? this.dataPointWidth : 0.6 * (f.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) :
        ...
        c.rect(f.x1, f.y1, f.width, f.height);
        c.clip();
        t && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1,
          f.y1, f.width, f.height), this._eventManager.ghostCtx.clip());
        for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
          var l = a.dataSeriesIndexes[h], s = this.data[l], v = s.dataPoints, e = s._colorSet[0];
          ...
          if (0 < v.length) for (var z = 5 < p && s.bevelEnabled ? !0 : !1, w = !1, y = null, B = null, n = 0; n < v.length; n++) if (v[n].getTime ?
            r = v[n].x.getTime() : r = v[n].x, "number" !== typeof v[n].y) {
            if (0 < n && !w && s.connectNullData) var D = s.options.nullDataLineDashType || !v[n - 1].lineDashType ? s.nullDataLineDashType : v[n - 1].lineDashType;
            w = !0
          } else {
            ...
            g = 0 === s.dataPointEOs[n].cumulativeSumYStartValue ? q : a.axisY.convertValueToPixel(s.dataPointEOs[n].cumulativeSumYStartValue);
            m = a.axisX.reversed ? m + a.plotType.totalDataSeries *
              p / 2 - (a.previousDataSeriesCount + h) * p << 0 : m - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + h) * p << 0;
            var E = a.axisX.reversed ? m - p << 0 : m + p << 0;
            k > g && (e = k, k = g, g = e);
            a.axisY.reversed && (e = k, k = g, g = e);
            e = s.dataPointIds[n];
            this._eventManager.objectMap[e] = {
              id: e,
              objectType: "dataPoint",
            ...
            var L = v[n].color ? v[n].color : 0 < v[n].y ? s.risingColor : s.fallingColor;
            da(c, m, k, E, g, L, 0, L, z, z, !1, !1, s.fillOpacity);
            e = R(e);
            t && da(this._eventManager.ghostCtx, m, k, E, g, e, 0, null, !1,
              !1, !1, !1);
            var O, L = m;
            O = "undefined" !== typeof v[n].isIntermediateSum && !0 === v[n].isIntermediateSum || "undefined" !== typeof v[n].isCumulativeSum && !0 === v[n].isCumulativeSum ? 0 < v[n].y ? k : g : 0 < v[n].y ? g : k;
            0 < n && y && (!w || s.connectNullData) && (w && c.setLineDash && c.setLineDash(P(D, u)), c.beginPath(), c.moveTo(y, B - x), c.lineTo(L, O - x), 0 < u && c.stroke(), t && (b.beginPath(), b.moveTo(y, B - x), b.lineTo(L, O - x), 0 < u && b.stroke()));
            w = !1;
            y = E;
            B = 0 < v[n].y ? k : g;
            ...
            c.lineWidth = u;
            c.setLineDash && (L = P(L, u), c.setLineDash(L));
            (v[n].indexLabel || s.indexLabel || v[n].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
              chartType: "waterfall",
              dataPoint: v[n],
              dataSeries: s,
              point: {x: m + (E - m) / 2, y: 0 <= v[n].y ? k : g},
              direction: 0 > v[n].y === a.axisY.reversed ? 1 : -1,
              bounds: {x1: m, y1: Math.min(k, g), x2: E, y2: Math.max(k, g)},
              color: e
            })
          }
        }
        t && (d.drawImage(this._preRenderCanvas, 0,
          0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(f.x1, f.y1, f.width, f.height), this._eventManager.ghostCtx.restore());
        c.restore();
        return {
          source: d, dest: this.plotArea.ctx, animationCallback: N.fadeInAnimation, easingFunction: N.easing.easeInQuad,
          animationBase: 0
        }
      }
    };
    var Y = function (a, d, c, b, e, f, n, m, k) {
      if (!(0 > c)) {
        ...
        if (!t) {
          var g = Number((n % (2 * Math.PI)).toFixed(8));
          Number((f % (2 * Math.PI)).toFixed(8)) === g && (n -= 1E-4)
        }
        a.save();
        a.globalAlpha = m;
        "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, n, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, n, !1), 0 <= k && a.arc(d.x, d.y, k * c, n, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
          2, a.fill());
        a.globalAlpha = 1;
        a.restore()
      }
    ...
    l.prototype.renderPie = function (a) {
      function d() {
        if (g && r) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
            var f = r[e], n = g.dataPointIds[e];
            h[e].id = n;
            h[e].objectType = "dataPoint";
            h[e].dataPointIndex = e;
            h[e].dataSeriesIndex = 0;
            var m = h[e], q = {percent: null, total: null}, l = null, q = k.getPercentAndTotal(g, f);
            if (g.indexLabelFormatter || f.indexLabelFormatter) l = {
              chart: k.options,
              dataSeries: g,
              dataPoint: f,
              total: q.total,
            ...
            q = f.indexLabelFormatter ? f.indexLabelFormatter(l) :
              f.indexLabel ? k.replaceKeywordsWithValue(f.indexLabel, f, g, e) : g.indexLabelFormatter ? g.indexLabelFormatter(l) : g.indexLabel ? k.replaceKeywordsWithValue(g.indexLabel, f, g, e) : f.label ? f.label : "";
            ...
            m.indexLabelText = q;
            m.indexLabelPlacement = g.indexLabelPlacement;
            m.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : g.options.indexLabelLineColor ? g.options.indexLabelLineColor : f.color ? f.color : g._colorSet[e %
            g._colorSet.length];
            m.indexLabelLineThickness = s(f.indexLabelLineThickness) ? g.indexLabelLineThickness : f.indexLabelLineThickness;
            m.indexLabelLineDashType = f.indexLabelLineDashType ? f.indexLabelLineDashType : g.indexLabelLineDashType;
            m.indexLabelFontColor = f.indexLabelFontColor ? f.indexLabelFontColor : g.indexLabelFontColor;
            m.indexLabelFontStyle = f.indexLabelFontStyle ? f.indexLabelFontStyle : g.indexLabelFontStyle;
            m.indexLabelFontWeight = f.indexLabelFontWeight ? f.indexLabelFontWeight : g.indexLabelFontWeight;
            m.indexLabelFontSize =
              s(f.indexLabelFontSize) ? g.indexLabelFontSize : f.indexLabelFontSize;
            m.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : g.indexLabelFontFamily;
            m.indexLabelBackgroundColor = f.indexLabelBackgroundColor ? f.indexLabelBackgroundColor : g.options.indexLabelBackgroundColor ? g.options.indexLabelBackgroundColor : g.indexLabelBackgroundColor;
            m.indexLabelMaxWidth = f.indexLabelMaxWidth ? f.indexLabelMaxWidth : g.indexLabelMaxWidth ? g.indexLabelMaxWidth : 0.33 * p.width;
            m.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ?
              f.indexLabelWrap : g.indexLabelWrap;
            m.startAngle = 0 === e ? g.startAngle ? g.startAngle / 180 * Math.PI : 0 : h[e - 1].endAngle;
            m.startAngle = (m.startAngle + 2 * Math.PI) % (2 * Math.PI);
            m.endAngle = m.startAngle + 2 * Math.PI / w * Math.abs(f.y);
            f = (m.endAngle + m.startAngle) / 2;
            f = (f + 2 * Math.PI) % (2 * Math.PI);
            m.midAngle = f;
            if (m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u) {
              if (0 === a || h[c].midAngle > m.midAngle) c = e;
              a++
            } else if (m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u) {
              if (0 === b || h[d].midAngle > m.midAngle) d = e;
              b++
            }
            m.hemisphere = f > Math.PI / 2 &&
            f <= 3 * Math.PI / 2 ? "left" : "right";
            m.indexLabelTextBlock = new la(k.plotArea.ctx, {
          ...
          n = f =
            0;
          q = !1;
          for (e = 0; e < r.length; e++) m = h[(c + e) % r.length], 1 < a && (m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !q ? (m.hemisphere = "right", f++) : (m.hemisphere = "left", q = !0));
          q = !1;
          for (e = 0; e < r.length; e++) m = h[(d + e) % r.length], 1 < b && (m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u) && (n <= b / 2 && !q ? (m.hemisphere = "left", n++) : (m.hemisphere = "right", q = !0))
        }
      }
      ...
      function c(a) {
        ...
        for (b = 0; b <
        r.length; b++) {
          var c = h[b].startAngle, d = h[b].endAngle;
          if (d > c) {
            var e = 0.07 * B * Math.cos(h[b].midAngle), f = 0.07 * B * Math.sin(h[b].midAngle), m = !1;
            if (r[b].exploded) {
              if (1E-9 < Math.abs(h[b].center.x - (z.x + e)) || 1E-9 < Math.abs(h[b].center.y - (z.y + f))) h[b].center.x = z.x + e * a, h[b].center.y = z.y + f * a, m = !0
            } else if (0 < Math.abs(h[b].center.x - z.x) || 0 < Math.abs(h[b].center.y - z.y)) h[b].center.x = z.x + e * (1 - a), h[b].center.y = z.y + f * (1 - a), m = !0;
            m && (e = {}, e.dataSeries = g, e.dataPoint = g.dataPoints[b], e.index = b, k.toolTip.highlightObjects([e]));
            Y(k.plotArea.ctx, h[b].center, h[b].radius, r[b].color ? r[b].color : g._colorSet[b % g._colorSet.length], g.type, c, d, g.fillOpacity, h[b].percentInnerRadius)
          }
        }
        a = k.plotArea.ctx;
        a.save();
        ...
        a.lineJoin = "round";
        for (b = b = 0; b < r.length; b++) c = h[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== g.indexLabelPlacement ? -(c.indexLabelTextBlock.width + q) : -c.indexLabelTextBlock.width / 2 : "inside" !==
        g.indexLabelPlacement ? q : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + B * Math.cos(c.midAngle), e = c.center.y + B * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(P(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(),
          a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -q : q), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
        a.save()
      }
      ...
      function e(a) {
        for (var c = null, d = 1; d < r.length; d++) if (c = (a + d + h.length) % h.length, h[c].hemisphere !== h[a].hemisphere) {
          c = null;
          break
        } else if (h[c].indexLabelText && c !== a && (0 > b(h[c], h[a]) || ("right" === h[a].hemisphere ? h[c].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[c].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break; else c = null;
        return c
      }
      ...
      function f(a, c, d) {
        ...
        if (1E3 < d) return 0;
        c = c || 0;
        var g = 0, m = z.y - 1 * t, n = z.y + 1 * t;
        if (0 <= a && a < r.length) {
          var k = h[a];
          if (0 > c && k.indexLabelTextBlock.y < m ||
            0 < c && k.indexLabelTextBlock.y > n) return 0;
          var p = 0, q = 0, q = p = p = 0;
          ...
          m = 0;
          m = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(t,
            2) - Math.pow(c - z.y, 2)) : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(c - z.y, 2));
          ...
          g && (d = k.indexLabelTextBlock.y + g, c = 0, c = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (m = (a - 1 + h.length) % h.length, m = h[m], a = h[(a + 1 + h.length) % h.length], "left" === k.hemisphere && "right" === m.hemisphere && c > m.indexLabelTextBlock.x ? c = m.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" ===
            ...
            z.y, k.indexLabelTextBlock.x - z.x))
        }
        return g
      }
      ...
      function n() {
        ...
        for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          if (g.radius || !g.radius && "undefined" !== typeof g.innerRadius && null !== g.innerRadius && B - d <= D) m = !1;
          m && (B -= d);
          d = 0;
          if ("inside" !== g.indexLabelPlacement) {
            t = B * v;
            ...
            for (var u, s, a = 0; a < r.length; a++) {
              ...
              if (null !== y) {
                ...
                var w = 0, w = b(u, s) - l;
                if (0 > w) {
                  for (var J = s = 0, I = 0; I < r.length; I++) I !== a && h[I].hemisphere === n.hemisphere && (h[I].indexLabelTextBlock.y < n.indexLabelTextBlock.y ? s++ : J++);
                  s = w / (s + J || 1) * J;
                  var J = -1 * (w - s), G = I = 0;
                  "right" === n.hemisphere ? (I = f(a, s), J = -1 * (w - I), G = f(y, J), +G.toFixed(x) < +J.toFixed(x) && +I.toFixed(x) <= +s.toFixed(x) && f(a, -(J - G))) : (I = f(y, s), J = -1 * (w - I), G = f(a, J), +G.toFixed(x) < +J.toFixed(x) &&
                  +I.toFixed(x) <= +s.toFixed(x) && f(y, -(J - G)))
                }
              }
            }
          } else for (a = 0; a < r.length; a++) n = h[a], t = "pie" === g.type ? 0.7 * B : 0.8 * B, y = z.x + t * Math.cos(n.midAngle), s = z.y + t * Math.sin(n.midAngle), n.indexLabelTextBlock.x = y, n.indexLabelTextBlock.y = s;
          for (a = 0; a < r.length; a++) if (n = h[a], y = n.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width + q), y *= -1) : y = p.x1 - (n.indexLabelTextBlock.x - n.indexLabelTextBlock.width - q), 0 < y && (!m && n.indexLabelText &&
          ...
          var K = function (a, b, c) {
            for (var d = [], e = 0; d.push(h[b]), b !== c; b = (b + 1 + r.length) % r.length) ;
            d.sort(function (a, b) {
              return a.y - b.y
            });
          ...
          (function () {
            for (var a = -1, c = -1, d = 0, f = !1, g = 0; g < r.length; g++) if (f = !1, u = h[g], u.indexLabelText) {
              var n = e(g);
              if (null !== n) {
                var m = h[n];
                w = 0;
                ...
                if (k = 0 > w) {
                  ...
                  var p = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                    ...
                    s = m.indexLabelTextBlock.y - m.indexLabelTextBlock.height /
                      2, A = m.indexLabelTextBlock.x + m.indexLabelTextBlock.width,
                ...
                k ? (0 > a && (a = g), n !== a && (c = n, d += -w), 0 === g % Math.max(r.length / 10, 3) && (f = !0)) : f = !0;
      ...
      function m() {
        ...
        k.title && (k.title.dockInsidePlotArea || "center" === k.title.horizontalAlign && "center" === k.title.verticalAlign) &&
        k.title.render();
      ...
      var k = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var g = this.data[a.dataSeriesIndexes[0]], r = g.dataPoints, q = 10, p = this.plotArea, h = g.dataPointEOs,
          l = 2, t, v = 1.3, u = 20 / 180 * Math.PI,
          x = 6, z = {x: (p.x2 + p.x1) / 2, y: (p.y2 + p.y1) / 2}, w = 0;
        a = !1;
        for (var y = 0; y < r.length; y++) w += Math.abs(r[y].y), !a && ("undefined" !== typeof r[y].indexLabel && null !== r[y].indexLabel && 0 < r[y].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof r[y].label && null !== r[y].label && 0 < r[y].label.toString().length) && (a = !0);
        if (0 !== w) {
          a = a || "undefined" !== typeof g.indexLabel && null !== g.indexLabel && 0 < g.indexLabel.toString().length;
          var B = "inside" !== g.indexLabelPlacement && a ? 0.75 * Math.min(p.width, p.height) / 2 : 0.92 * Math.min(p.width,
            p.height) / 2;
          g.radius && (B = Ra(g.radius, B));
          var D = "undefined" !== typeof g.innerRadius && null !== g.innerRadius ? Ra(g.innerRadius, B) : 0.7 * B;
          g.radius = B;
          "doughnut" === g.type && (g.innerRadius = D);
          ...
          this._animator.animate(0,
            this.animatedRender ? this.animationDuration : 0, function (a) {
              ...
              b.fillStyle = k.backgroundColor;
              b.fillRect(p.x1, p.y1, p.width, p.height);
              a = h[0].startAngle + 2 * Math.PI * a;
              for (b = 0; b < r.length; b++) {
                var c = 0 === b ? h[b].startAngle : d, d = c + (h[b].endAngle - h[b].startAngle), e = !1;
                d > a && (d = a, e = !0);
                var f = r[b].color ? r[b].color : g._colorSet[b % g._colorSet.length];
                d > c && Y(k.plotArea.ctx, h[b].center, h[b].radius, f, g.type, c, d, g.fillOpacity, h[b].percentInnerRadius);
                if (e) break
              }
              m()
            },
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        f = Math.abs(f);
        f = d + f;
        for (var d = [], h = 0, g = 0; g < x.length; g++) {
          if ("undefined" ===
            typeof x[g].y) return -1;
          x[g].y = "number" === typeof x[g].y ? x[g].y : 0;
          h += Math.abs(x[g].y)
        }
        if (0 === h) return -1;
        for (var n = d[0] = 0, m = 0, k, r, b = b - a, n = !1, g = 0; g < x.length; g++) a = Math.abs(x[g].y) * f / h, n ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (r = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > r ? (r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += 0 == r ? 0 : a / r, m += a / r, n = !0) : (k = (Math.abs(ba) * b - Math.sqrt(r)) / 2, r = b - 2 * k / Math.abs(ba), m += k, m > e && (m -= k, r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += a / r, m += a / r, n = !0), b = r)), d.push(k);
        return d
      }
      ...
      function b() {
        if (u && x) {
          for (var a,
                 b, c, d, e, f, g, m, n, k, r, p, q, l, A = [], C = [], v = {
              percent: null,
              total: null
            }, z = null, y = 0; y < x.length; y++) l = Q[y], l = "undefined" !== typeof l.x5 ? (l.y2 + l.y4) / 2 : (l.y2 + l.y3) / 2, l = h(l).x2 + 1, A[y] = M - l - V;
          l = 0.5 * V;
          for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
            ...
            d = b.indexLabelBackgroundColor || u.indexLabelBackgroundColor || (t ? "transparent" :
              null);
            e = b.indexLabelFontColor || u.indexLabelFontColor || "#979797";
            f = s(b.indexLabelFontSize) ? u.indexLabelFontSize : b.indexLabelFontSize;
            g = b.indexLabelFontStyle || u.indexLabelFontStyle || "normal";
            ...
            k = "number" === typeof b.indexLabelLineThickness ? b.indexLabelLineThickness : "number" === typeof u.indexLabelLineThickness ? u.indexLabelLineThickness :
              2;
            ...
            w._eventManager.objectMap[q] = {
              ...
              dataPointIndex: y,
              dataSeriesIndex: 0,
              funnelSection: Q[u.reversed ? x.length - 1 - y : y]
            };
            "inside" === u.indexLabelPlacement && (A[y] = y !== da ? u.reversed ? Q[y].x2 - Q[y].x1 : Q[y].x3 - Q[y].x4 : Q[y].x3 - Q[y].x6, 20 > A[y] && (A[y] = y !== da ? u.reversed ? Q[y].x3 - Q[y].x4 : Q[y].x2 - Q[y].x1 :
              Q[y].x2 - Q[y].x1, A[y] /= 2));
            q = b.indexLabelMaxWidth ? b.indexLabelMaxWidth : u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth : A[y];
            if (q > A[y] || 0 > q) q = A[y];
            C[y] = "inside" === u.indexLabelPlacement ? Q[y].height : !1;
            ...
            b = b.indexLabelFormatter ? b.indexLabelFormatter(z) : b.indexLabel ? w.replaceKeywordsWithValue(b.indexLabel, b, u, y) : u.indexLabelFormatter ? u.indexLabelFormatter(z) :
              u.indexLabel ? w.replaceKeywordsWithValue(u.indexLabel, b, u, y) : b.label ? b.label : "";
            0 >= k && (k = 0);
      ...
      function e() {
        ...
        e = !1;
        c = 0;
        for (var h, g = M - $ - V / 2, g = u.options.indexLabelMaxWidth ? u.indexLabelMaxWidth > g ? g : u.indexLabelMaxWidth : g, m = H.length - 1; 0 <= m; m--) {
          h = x[H[m].id];
          c = H[m];
          d = c.textBlock;
          b = (a = p(m) < Q.length ? H[p(m)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + ea > b.y && (e = !0);
          c = h.indexLabelMaxWidth || g;
          if (c > g || 0 > c) c = g;
          f.push(c)
        }
        if (e) for (m = H.length - 1; 0 <= m; m--) a = Q[m], H[m].textBlock.maxWidth = f[f.length - (m + 1)], H[m].textBlock.measureText(), H[m].textBlock.x = M - g, c = H[m].textBlock.height <
      ...
      function n() {
        ...
        function b() {
          ...
          for (var m, n = 1; n < g; n++) {
            e = n * f;
            for (var r = H.length - 1; 0 <= r; r--) !H[r].isDirty && (H[r].textBlock.y < e && H[r].textBlock.y + H[r].height > e) && (m = p(r), !(m >= H.length - 1) && H[r].textBlock.y + H[r].height + ea > H[m].textBlock.y &&
            (H[r].textBlock.y = H[r].textBlock.y + H[r].height - e > e - H[r].textBlock.y ? e + 1 : e - H[r].height - 1))
          }
          for (m = Q.length - 1; 0 < m; m--) if (!H[m].isDirty) {
            e = q(m);
            if (0 > e && (e = 0, H[e].isDirty)) break;
            if (H[m].textBlock.y < H[e].textBlock.y + H[e].height) {
              d = d || m;
              f = m;
              for (g = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) {
        ...
        function c(a,
          ...
          for (d = 0; d < e.length; d++) if (b = e[d], f < a) g++, f += H[b.id].height + ea, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText(); else break;
          return g
        }

        for (var d, e, f, h, g, n, k = 1, r = 0; r < 2 * k; r++) {
          for (var l = H.length - 1; 0 <= l && !(0 <= q(l) && q(l), f = H[l], h = f.textBlock, n = (g = p(l) < Q.length ? H[p(l)] : null) ? g.textBlock : null, d = +f.height.toFixed(6), e = +h.y.toFixed(6), !f.isDirty &&
          (g && e + d + ea > +n.y.toFixed(6)) && (d = h.y + d + ea - n.y, e = a(l, -d), e < d && (0 < e && (d -= e), e = a(p(l), d), e != d))); l--) ;
          b()
        }
      }

      function m(a, b) {
        return (b < Q.length ? H[b].textBlock.y : u.reversed ? T + D : sa + D) - (0 > a ? u.reversed ? sa - D : T - D : H[a].textBlock.y + H[a].height + ea)
      }
      ...
      function k(a, b, c) {
        ...
        if (0 === Y.length) m = ja; else {
          e = D * (1 != Y.length || 0 != Y[0] && Y[0] != Q.length - 1 ? 2 : 1) / g();
          for (var p = 0; p < Q.length; p++) {
            ...
            m.push(ja[p] + d);
            if (0 <= Y.indexOf(p) || p < Q.length && 0 <= Y.indexOf(p + 1)) d += e
          }
        }
        h = function () {
          for (var a = [], b = 0; b < Q.length; b++) a.push(m[b] - Q[b].y1);
          return a
        }();
        var s = {
          startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, d) {
            ...
            for (var b, c, d = 0; d < Q.length; d++) b = h[d], c = Q[d], b *= a, "undefined" === typeof q[d] && (q[d] = 0), 0 > q && (q *= -1), c.y1 += b - q[d], c.y2 += b - q[d], c.y3 +=
              b - q[d], c.y4 += b - q[d], c.y5 && (c.y5 += b - q[d], c.y6 += b - q[d]), q[d] = b
          }
        };
        a._animator.animate(0, c, function (c) {
          ...
          for (e = 0; e < Q.length; e++) qa(d, Q[e], u.fillOpacity);
          v(d);
          L && ("inside" !== u.indexLabelPlacement ?
            r(d) : f(), l(d));
          1 <= c && (ka = !1)
      ...
      function g() {
        for (var a = 0, b = 0; b < Q.length - 1; b++) (0 <= Y.indexOf(b) || 0 <= Y.indexOf(b + 1)) && a++;
        return a
      }
      ...
      function p(a) {
        for (a += 1; a <= Q.length && a != Q.length && H[a].isDirty; a++) ;
        return a
      }

      function h(a) {
        for (var b, c = 0; c < x.length; c++) if (Q[c].y1 < a && Q[c].y4 > a) {
          b = Q[c];
          break
        }
      ...
      function l(a) {
        for (var b = 0; b < Q.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx =
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, G = Math.min(z.width - 2 * y, 2.8 * z.height), L = !1, O = 0; O < x.length; O++) if (!L && ("undefined" !== typeof x[O].indexLabel && null !== x[O].indexLabel && 0 < x[O].indexLabel.toString().length) && (L = !0), !L && ("undefined" !== typeof x[O].label && null !== x[O].label &&
          0 < x[O].label.toString().length) && (L = !0), !L && "function" === typeof u.indexLabelFormatter || "function" === typeof x[O].indexLabelFormatter) L = !0;
        L = L || "undefined" !== typeof u.indexLabel && null !== u.indexLabel && 0 < u.indexLabel.toString().length;
        "inside" !== u.indexLabelPlacement && L || (y = (z.width - 0.75 * G) / 2);
        var O = z.x1 + y, M = z.x2 - y, Z = z.y1 + D, S = z.y2 - D,
          R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
        if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
          var ca, F;
          a = 75 * G / 100;
          var V = 30 * (M - a) / 100;
          "funnel" === u.type ? (ca = s(u.options.neckHeight) ?
            0.35 * E : u.neckHeight, F = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof ca && ca.match(/%$/) ? (ca = parseInt(ca), ca = ca * E / 100) : ca = parseInt(ca), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), ca > E ? ca = E : 0 >= ca && (ca = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = ca = 0, u.reversed = u.reversed ? !1 : !0);
          var y = O + a / 2, W = O, $ = O + a, T = u.reversed ? S : Z, K = y - F / 2, X = y + F / 2,
            xa = u.reversed ? Z + ca : S - ca, sa = u.reversed ? Z : S;
          a = [];
          var y = [], Q = [], G = [], U = Z, da, ba = (xa - T) / (K - W), fa = -ba, O = "area" === (u.valueRepresents ?
            u.valueRepresents : "height") ? c() : d();
          if (-1 !== O) {
            if (u.reversed) for (G.push(U), F = O.length - 1; 0 < F; F--) U += O[F], G.push(U); else for (F = 0; F < O.length; F++) U += O[F], G.push(U);
            if (u.reversed) for (F = 0; F < O.length; F++) G[F] < xa ? (a.push(K), y.push(X), da = F) : (a.push((G[F] - T + ba * W) / ba), y.push((G[F] - T + fa * $) / fa)); else for (F = 0; F < O.length; F++) G[F] < xa ? (a.push((G[F] - T + ba * W) / ba), y.push((G[F] - T + fa * $) / fa), da = F) : (a.push(K), y.push(X));
            for (F = 0; F < O.length - 1; F++) U = u.reversed ? x[x.length - 1 - F].color ? x[x.length - 1 - F].color : u._colorSet[(x.length -
              1 - F) % u._colorSet.length] : x[F].color ? x[F].color : u._colorSet[F % u._colorSet.length], F === da ? Q.push({
              x1: a[F],
              y1: G[F],
              x2: y[F],
              y2: G[F],
            ...
            var ea = 2, H = [], ka = !1, Y = [], ja = [], O = !1;
            a = a = 0;
            Ca(Y);
            for (F = 0; F < x.length; F++) x[F].exploded && (O = !0, u.reversed ? Y.push(x.length - 1 - F) : Y.push(F));
            R.clearRect(z.x1, z.y1, z.width,
              z.height);
            R.fillStyle = w.backgroundColor;
            R.fillRect(z.x1, z.y1, z.width, z.height);
            if (L && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
              n();
              for (F = 0; F < x.length; F++) H[F].isDirty || (a = H[F].textBlock.x + H[F].width, a = (M - a) / 2, 0 == F && (B = a), B > a && (B = a));
              for (F = 0; F < Q.length; F++) Q[F].x1 += B, Q[F].x2 += B, Q[F].x3 += B, Q[F].x4 += B, Q[F].x5 && (Q[F].x5 += B, Q[F].x6 += B), H[F].textBlock.x += B
            }
            for (F = 0; F < Q.length; F++) B = Q[F], qa(R, B, u.fillOpacity), ja.push(B.y1);
            v(R);
            L && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled ||
            r(R), w.animationEnabled || l());
            if (!L) for (F = 0; F < x.length; F++) B = u.dataPointIds[F], a = {
              id: B,
              objectType: "dataPoint",
              dataPointIndex: F,
              dataSeriesIndex: 0,
              funnelSection: Q[u.reversed ? x.length - 1 - F : F]
            }, w._eventManager.objectMap[B] = a;
            !w.animationEnabled && O ? k(w, -1, 0) : w.animationEnabled && !w.animatedRender && k(w, -1, 0);
            this.funnelPyramidClickHandler = function (a) {
              var b = -1;
              if (!ka && !w.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <=
              b)) {
                a = b;
    ...
    l.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
        ...
        do {
          ...
          if (c.percentFormatString) k = c.percentFormatString;
            ...
            var k = "#,##0.", g = Math.max(Math.ceil(Math.log(1 / Math.abs(n)) / Math.LN10), 2);
            if (isNaN(g) || !isFinite(g)) g = 2;
            for (var r = 0; r < g; r++) k += "#";
            c.percentFormatString = k
          }
          a = a.replace("#percent", fa(n, k, f._cultureInfo));
          a = a.replace("#total", fa(m, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo))
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          h && 0 < h.length && (g = Fa(h[2]), a = Fa(h[1]))
        } catch (m) {
        }
        h = null;
        if ("color" === a) return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[g % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
        if (d.hasOwnProperty(a)) h = d; else if (c.hasOwnProperty(a)) h = c; else return "";
        h = h[a];
        null !== g && (h = h[g]);
        ...
        } else return fa(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString :
          c.xValueFormatString = "#,##0.########", f._cultureInfo); else return "y" === a ? fa(h, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? fa(h, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : h
      })
    };
    oa(E, W);
    E.prototype.setLayout = function () {
      ...
      for (var r = 0; r < this.dataSeries.length; r++) {
        ...
        if (q.dataPoints && q.dataPoints.length) if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
          var p = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ?
            "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : G.getDefaultLegendMarker(q._linkedSeries.type) : G.getDefaultLegendMarker(q.type) : q.markerType,
            h = q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({
              chart: this.chart,
              legend: this.options,
              dataSeries: q,
              dataPoint: null
          ...
          h = this.chart.replaceKeywordsWithValue(h, q.dataPoints[0], q, r);
          p = {
            markerType: p,
            markerColor: l,
            text: h,
          ...
          var z = q.dataPoints[x],
            p = z.legendMarkerType ? z.legendMarkerType : q.legendMarkerType ? q.legendMarkerType : G.getDefaultLegendMarker(q.type),
            h = z.legendText ? z.legendText : q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({
              chart: this.chart,
              legend: this.options,
              dataSeries: q,
              dataPoint: z
            ...
            h = this.chart.replaceKeywordsWithValue(h,
              z, q, x), p = {
              markerType: p,
              markerColor: l,
              text: h,
      ...
      if (0 < k.length) {
          ...
          if (!(0 >= n || "undefined" === typeof n || 0 >= v || "undefined" === typeof v)) {
            if ("horizontal" === this.orientation) {
              ...
              if (!q || q.width + Math.round(p.textBlock.width + t + m + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) q = {
                items: [],
                width: 0
              }, g.push(q), this.height += h, h = 0;
              h = Math.max(h, p.textBlock.height)
            } else p.textBlock =
              new la(this.ctx, {
                x: 0,
                y: 0,
              ...
              items: [],
              width: 0
            }, g.push(q)) : (q = g[x], x = (x + 1) % g.length), this.height += p.textBlock.height;
        ...
        this.itemWidth = l;
        this.height =
          !1 === this.itemWrap ? g.length * this.lineHeight : this.height + h;
    ...
    E.prototype.render = function () {
      ...
      for (var m = 0, k = 0; k < n.length; k++) {
        for (var g = n[k], r = 0, q = 0; q < g.items.length; q++) {
          var p = g.items[q], h = p.textBlock.x + a + (0 === q ? 0.2 * f : this.horizontalSpacing),
            l = d + m, s = h;
          ...
          this.ctx.clip();
          if ("line" === p.chartType || "stepLine" === p.chartType || "spline" === p.chartType) this.ctx.strokeStyle = p.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(h - 0.1 * this.lineHeight, l + this.lineHeight / 2), this.ctx.lineTo(h + 0.85 * this.lineHeight, l + this.lineHeight / 2), this.ctx.stroke(), s -=
            0.1 * this.lineHeight;
          if ("error" === p.chartType) {
            this.ctx.strokeStyle = this.errorMarkerColor[0];
            this.ctx.lineWidth = f / 8;
            this.ctx.beginPath();
            var t = h - 0.08 * this.lineHeight + 0.1 * this.lineHeight, u = l + 0.15 * this.lineHeight,
    ...
    G.prototype.getDataPointAtX = function (a, d) {
      ...
      var c = {
        ...
        index: NaN
      }, b = null, e = 0, f = 0, n = 1, m = Infinity, k = 0, g = 0, r = 0;
      ...
      for (; ;) {
        ...
        if (0 <= f && f < this.dataPoints.length) {
          var b = this.dataPoints[f], q = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
          q < c.distance && (c.dataPoint = b, c.distance = q, c.index = f);
          b = q;
          b <= m ? m = b : 0 < n ? k++ : g++;
          if (1E3 < k && 1E3 < g) break
    ...
    G.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      c = c || !1;
      var b = [], e = 0, f = 0, n = 1, m = !1, k = Infinity, g = 0, r = 0, q = 0;
      ...
      for (; ;) {
        f = 0 < n ? q + e : q - e;
        if (0 <= f && f < this.dataPoints.length) {
          var p = this.chart._eventManager.objectMap[this.dataPointIds[f]], h = this.dataPoints[f], l = null;
          if (p) {
            switch (this.type) {
              case "column":
              case "stackedColumn":
              ...
              case "splineArea":
              case "scatter":
                var s = ma("markerSize", h, this) || 4, t = c ? 20 : s,
                  l = Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y1 - d, 2));
                l <= t && b.push({dataPoint: h, dataPointIndex: f, dataSeries: this, distance: l});
                p =
                  Math.abs(p.x1 - a);
                p <= k ? k = p : 0 < n ? g++ : r++;
                l <= s / 2 && (m = !0);
              ...
              case "doughnut":
                ...
                l < p.radius && l > t && (l = Math.atan2(d - s.y, a - s.x), 0 > l && (l += 2 * Math.PI), l = Number(((180 * (l / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (p.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), t = Number(((180 * (p.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === t && 1 < p.endAngle && (t = 360), s >= t && 0 !== h.y && (t += 360, l < s && (l += 360)), l > s && l < t && (b.push({
                  dataPoint: h,
              ...
              case "ohlc":
                if (Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y2 && d <= p.y3 || a >= p.x1 && a <= (p.x2 + p.x1) / 2 && d >= p.y1 - p.borderThickness / 2 && d <= p.y1 + p.borderThickness / 2 || a >= (p.x1 + p.x2) / 2 && a <= p.x2 && d >= p.y4 - p.borderThickness / 2 && d <= p.y4 + p.borderThickness / 2) b.push({
                  dataPoint: h, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(p.x1 - a),
                    Math.abs(p.x2 - a), Math.abs(p.y2 - d), Math.abs(p.y3 - d))
                }), m = !0
            }
            if (m || 1E3 < g && 1E3 < r) break
          }
    ...
    D.prototype.createLabels = function () {
      var a, d, c = 0, b = 0, e, f = 0, n = 0, b = 0, b = this.interval, m = 0, k, g = 0.6 * this.chart.height, l;
      a = !1;
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        if (this.labels) {
          a = Math.ceil(b);
          for (var b = Math.ceil(this.intervalStartPosition), h = !1, c = b; c < this.viewportMaximum; c += a) if (this.labels[c]) h = !0; else {
            h = !1;
            break
          }
          h && (this.interval = a, this.intervalStartPosition = b)
        }
        if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, h = p; b < this.logLabelValues.length; b++) if (c =
          this.logLabelValues[b], c < this.viewportMinimum) b++; else {
          for (; h < q.length && c > q[h].endValue; h++) ;
          a = h < q.length && c >= q[h].startValue && c <= q[h].endValue;
          l = c;
          ...
          }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : fa(l, this.valueFormatString, this.chart._cultureInfo), a = new la(this.ctx, {
            x: 0,
            y: 0,
            maxWidth: f,
            maxHeight: n,
        ...
        for (c = this.intervalStartPosition; c <= e; c = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase,
          ...
          a || (a = this.labelFormatter ? this.labelFormatter({
            ...
            textBaseline: "middle"
                    ...
                    this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Va(new Date(this.viewportMaximum), this.interval, this.intervalType), h = p, c = this.intervalStartPosition; c < e; Va(c, b, this.intervalType)) {
        for (a = c.getTime(); h < q.length && a > q[h].endValue; h++) ;
        l = a;
        a = h < q.length && a >= q[h].startValue && a <= q[h].endValue;
        a || (a = this.labelFormatter ? this.labelFormatter({
          chart: this.chart,
          axis: this.options,
          value: new Date(l),
          ...
          this.labels[l] : Aa(l, this.valueFormatString, this.chart._cultureInfo), a = new la(this.ctx, {
          x: 0,
          y: 0,
          maxWidth: f,
          backgroundColor: this.labelBackgroundColor,
      ...
      1 <= this._labels.length) {
        ...
        for (c = 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          for (var v, h = a.text.split(" "), b = 0; b < h.length; b++) l = h[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, l = this.ctx.measureText(l),
        ...
        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++) if (!this._labels[c].breaksLabelType) {
          ...
          if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle) if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), l = (g - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ?
            ...
            if (s(this.options.labelWrap)) if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ?
              ...
              !0, b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, p), l), C = a.measureText(), b < this._labels.length - 1 && (h = b + 1, d = this._labels[h].textBlock, d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, p), l), d = d.measureText(), C.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
    ...
    D.prototype.createLabelsAndCalculateWidth =
      function () {
        ...
        if ("left" === this._position || "right" === this._position) {
          this.createLabels();
          if ("inside" != this.labelPlacement) for (d = 0; d < this._labels.length; d++) {
        ...
        return (this.title ?
          this._titleTextBlock.measureText().height + 2 : 0) + a + ("inside" === this.tickPlacement ? 0 : this.tickLength) + c
      };
    D.prototype.createLabelsAndCalculateHeight = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        this.createLabels();
        if ("inside" != this.labelPlacement) for (c = 0; c < this._labels.length; c++) {
          d = this._labels[c].textBlock;
          var e = d.measureText(), f = 0,
            f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) +
              (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
          a < f && (a = f);
        ...
        for (c = 0; c < this._stripLineLabels.length; c++) "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (d = this._stripLineLabels[c].textBlock, e = d.measureText(), f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height -
          d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), a < f && (a = f), this._stripLineLabels[c].effectiveHeight = f)
      }
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      var n, m, k, g, l = a[0] ? a[0].chart : d[0].chart, q = l.isNavigator ? 0 : 10, p = l._axes;
      ...
      if (c &&
        0 < c.length) for (h = 0; h < c.length; h++) c[h].calculateAxisParameters();
      ...
      for (h = 0; h < p.length; h++) if (p[h] && p[h].scaleBreaks && p[h].scaleBreaks._appliedBreaks.length) for (var t = p[h].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[h].viewportMaximum); v++) t[v].endValue < p[h].viewportMinimum || (s(p[h].scaleBreaks.firstBreakIndex) && (p[h].scaleBreaks.firstBreakIndex = v), t[v].startValue >= p[h].viewPortMinimum && (p[h].scaleBreaks.lastBreakIndex =
        v));
      for (var w = v = 0, u = 0, x = 0, z = 0, D = 0, y = 0, B, E, G = m = 0, I, O, M, t = I = O = M = !1, h = 0; h < p.length; h++) p[h] && p[h].title && (p[h]._titleTextBlock = new la(p[h].ctx, {
        text: p[h].title,
        horizontalAlign: "center",
      ...
      for (h = 0; h < p.length; h++) if (p[h].title) switch (p[h]._position) {
        case "left":
          p[h]._titleTextBlock.maxWidth = p[h].titleMaxWidth || f.height;
          p[h]._titleTextBlock.maxHeight = p[h].titleWrap ? 0.8 * f.width : 1.5 * p[h].titleFontSize;
        ...
        case "right":
          ...
          break;
        default:
          p[h]._titleTextBlock.maxWidth = p[h].titleMaxWidth || f.width,
            p[h]._titleTextBlock.maxHeight = p[h].titleWrap ? 0.8 * f.height : 1.5 * p[h].titleFontSize, p[h]._titleTextBlock.angle = 0
      }
      if ("normal" === e) {
        for (var x = [], z = [], D = [], y = [], N = [], P = [], R = [], S = []; 4 > v;) {
          var F = 0, V = 0, T = 0, W = 0, Y = e = 0, K = 0, $ = 0, U = 0, X = 0, Q = 0, ba = 0;
          if (c && 0 < c.length) for (D = [], h = Q = 0; h < c.length; h++) D.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), Q += D[h], K += c[h] && !l.isNavigator ? c[h].margin : 0; else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          R.push(D);
          if (b && 0 < b.length) for (y = [], h = ba = 0; h <
          b.length; h++) y.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), ba += y[h], $ += b[h] ? b[h].margin : 0; else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
          S.push(y);
          n = Math.round(f.x1 + Q + K);
          k = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $);
          if (a && 0 < a.length) for (x = [], h = U = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates = {}), a[h].lineCoordinates.width = Math.abs(k - n), a[h].title && (a[h]._titleTextBlock.maxWidth = 0 < a[h].titleMaxWidth && a[h].titleMaxWidth < a[h].lineCoordinates.width ? a[h].titleMaxWidth :
            a[h].lineCoordinates.width), x.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateHeight() : 0)), U += x[h], e += a[h] && !l.isNavigator ? a[h].margin : 0; else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
          N.push(x);
          if (d && 0 < d.length) for (z = [], h = X = 0; h < d.length; h++) d[h] && (d[h].lineCoordinates = {}), d[h].lineCoordinates.width = Math.abs(k - n), d[h].title && (d[h]._titleTextBlock.maxWidth = 0 < d[h].titleMaxWidth && d[h].titleMaxWidth < d[h].lineCoordinates.width ? d[h].titleMaxWidth : d[h].lineCoordinates.width), z.push(Math.ceil(d[h] ?
            d[h].createLabelsAndCalculateHeight() : 0)), X += z[h], Y += d[h] && !l.isNavigator ? d[h].margin : 0; else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
          P.push(z);
          if (a && 0 < a.length) for (h = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates.x1 = n, k = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), a[h]._labels && 1 < a[h]._labels.length && (m = g = 0, g = a[h]._labels[1], m = "dateTime" === a[h].valueType ? a[h]._labels[a[h]._labels.length - 2] : a[h]._labels[a[h]._labels.length - 1], w = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) +
            ...
            U : l.sessionVariables.axisX.height : l.sessionVariables.axisX.height = U, m = Math.round(f.y2 - U - e + F), g = Math.round(f.y2), a[h].lineCoordinates.x2 = k, a[h].lineCoordinates.width = k - n, a[h].lineCoordinates.y1 = m, a[h].lineCoordinates.y2 = m, a[h].bounds = {
            x1: n,
            y1: m,
            x2: k,
            y2: g - (U + e - x[h] - F),
          ...
          if (d && 0 < d.length) for (h = 0; h < d.length; h++) d[h].lineCoordinates.x1 = Math.round(f.x1 + Q + K), d[h].lineCoordinates.x2 = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), d[h].lineCoordinates.width = Math.abs(k -
            ...
            X = s(l.sessionVariables.axisX2.height) ? l.sessionVariables.axisX2.height = X : l.sessionVariables.axisX2.height : l.sessionVariables.axisX2.height = X, m = Math.round(f.y1), g = Math.round(f.y2 + d[h].margin), d[h].lineCoordinates.y1 = m + X + Y - V, d[h].lineCoordinates.y2 = m, d[h].bounds = {
            x1: n,
            y1: m + (X + Y - z[h] - V),
            x2: k,
            y2: g,
          ...
          if (c && 0 < c.length) for (h = 0; h < c.length; h++) K = l.isNavigator ? 0 : 10, c[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[h]._labels && 0 < c[h]._labels.length ?
            c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : q, m = Math.round(f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : q, g = Math.round(f.y2 - U - e - K), c[h].lineCoordinates = {
            x1: k - T,
            y1: m,
            x2: k - T,
            y2: g,
          ...
          if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(n), K = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0, m = Math.round(f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y), K = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0, g = Math.round(f.y2 - (U + e + K)), b[h].lineCoordinates =
            ...
            width: k - n,
            height: g - m
          }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.height ? b[h].titleMaxWidth : b[h].lineCoordinates.height), W += y[h] + b[h].margin);
          if (a && 0 < a.length) for (h = 0; h < a.length; h++) a[h] && (a[h].calculateValueToPixelConversionParameters(), a[h].calculateBreaksSizeInValues(), a[h]._labels && 1 < a[h]._labels.length && (B = (a[h].logarithmic ? Math.log(a[h]._labels[1].position /
            ...
            0) + a[h].lineCoordinates.x1));
          if (d && 0 < d.length) for (h = 0; h < d.length; h++) d[h].calculateValueToPixelConversionParameters(), d[h].calculateBreaksSizeInValues(), d[h]._labels && 1 < d[h]._labels.length && (B = (d[h].logarithmic ? Math.log(d[h]._labels[1].position / d[h].viewportMinimum) / d[h].conversionParameters.lnLogarithmBase : d[h]._labels[1].position - d[h].viewportMinimum) * Math.abs(d[h].conversionParameters.pixelPerUnit) + d[h].lineCoordinates.x1, n = d[h]._labels[d[h]._labels.length - ("dateTime" === d[h].valueType ? 2 : 1)].position,
            n = d[h].getApparentDifference(d[h].viewportMinimum, n), E = d[h].logarithmic ? (1 < n ? Math.log(n) / d[h].conversionParameters.lnLogarithmBase * Math.abs(d[h].conversionParameters.pixelPerUnit) : 0) + d[h].lineCoordinates.x1 : (0 < n ? n * Math.abs(d[h].conversionParameters.pixelPerUnit) : 0) + d[h].lineCoordinates.x1);
          for (h = 0; h < p.length; h++) "axisY" === p[h].type && (p[h].calculateValueToPixelConversionParameters(), p[h].calculateBreaksSizeInValues());
          if (0 < v) {
            if (a && 0 < a.length) for (h = 0; h < a.length; h++) t = N[v - 1][h] === N[v][h] ? !0 : !1; else t =
              !0;
            if (d && 0 < d.length) for (h = 0; h < d.length; h++) I = P[v - 1][h] === P[v][h] ? !0 : !1; else I = !0;
            if (c && 0 < c.length) for (h = 0; h < c.length; h++) O = R[v - 1][h] === R[v][h] ? !0 : !1; else O = !0;
            if (b && 0 < b.length) for (h = 0; h < b.length; h++) M = S[v - 1][h] === S[v][h] ? !0 : !1; else M = !0
          }
          if (t && I && O && M) break;
          v++
        }
        ...
        if (c && 0 < c.length) for (h =
                                      0; h < c.length; h++) c[h].calculateStripLinesThicknessInValues(), c[h].calculateBreaksInPixels();
        ...
        N = [];
        for (P = []; 4 > v;) {
          U = W = V = T = $ = K = Y = e = S = R = F = X = 0;
          if (a && 0 < a.length) for (G = [], h = W = 0; h < a.length; h++) G.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)), W += G[h], e += a[h] && !l.isNavigator ? a[h].margin : 0; else G.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() :
            0));
          N.push(G);
          if (d && 0 < d.length) for (w = [], h = U = 0; h < d.length; h++) w.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)), U += w[h], Y += d[h] ? d[h].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
          P.push(w);
          if (c && 0 < c.length) for (h = 0; h < c.length; h++) c[h].lineCoordinates = {}, n = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > l.width - 10 ? l.width - 10 : f.x2 - U - Y), c[h].labelAutoFit && !s(x) && (0 < !a.length && (n = 0 > c[h].labelAngle ? Math.max(n, x) : 0 === c[h].labelAngle ? Math.max(n, x / 2) : n), 0 < !d.length && (k =
            0 < c[h].labelAngle ? k - z / 2 : 0 === c[h].labelAngle ? k - z / 2 : k)), c[h].lineCoordinates.x1 = n, c[h].lineCoordinates.x2 = k, c[h].lineCoordinates.width = Math.abs(k - n), c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width);
          if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h].lineCoordinates = {}, n = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - U - Y), b[h] && b[h].labelAutoFit && !s(D) && (0 < !a.length &&
          (n = 0 < b[h].labelAngle ? Math.max(n, D) : 0 === b[h].labelAngle ? Math.max(n, D / 2) : n), 0 < !d.length && (k -= y / 2)), b[h].lineCoordinates.x1 = n, b[h].lineCoordinates.x2 = k, b[h].lineCoordinates.width = Math.abs(k - n), b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width);
          if (c && 0 < c.length) for (q = [], h = T = 0; h < c.length; h++) q.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), T += q[h] + c[h].margin, K += c[h].margin; else q.push(Math.ceil(c[0] ?
            c[0].createLabelsAndCalculateHeight() : 0));
          E.push(q);
          if (b && 0 < b.length) for (B = [], h = V = 0; h < b.length; h++) B.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), V += B[h], $ += b[h].margin; else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          u.push(B);
          if (c && 0 < c.length) for (h = 0; h < c.length; h++) 0 < c[h]._labels.length && (g = c[h]._labels[0], m = c[h]._labels[c[h]._labels.length - 1], x = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI /
            180 * Math.abs(g.textBlock.angle)), z = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
          if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h] && 0 < b[h]._labels.length && (g = b[h]._labels[0], m = b[h]._labels[b[h]._labels.length - 1], D = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)), y = m.textBlock.width *
            Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
          if (l.panEnabled) for (h = 0; h < c.length; h++) q[h] = s(l.sessionVariables.axisY.height) ? l.sessionVariables.axisY.height = q[h] : l.sessionVariables.axisY.height; else for (h = 0; h < c.length; h++) l.sessionVariables.axisY.height = q[h];
          if (c && 0 < c.length) for (h = c.length - 1; 0 <= h; h--) m = Math.round(f.y2), g = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2), c[h].lineCoordinates.y1 =
            m - (q[h] + c[h].margin + X), c[h].lineCoordinates.y2 = m - (q[h] + c[h].margin + X), c[h].bounds = {
            x1: n,
            y1: m - (q[h] + X + c[h].margin),
            x2: k,
            y2: g - (X + c[h].margin),
            width: k - n,
            height: q[h]
          }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.width ? c[h].titleMaxWidth : c[h].lineCoordinates.width), X += q[h] + c[h].margin;
          if (b && 0 < b.length) for (h = b.length - 1; 0 <= h; h--) b[h] && (m = Math.round(f.y1), g = Math.round(f.y1 + (B[h] + b[h].margin + F)), b[h].lineCoordinates.y1 = g, b[h].lineCoordinates.y2 = g,
            b[h].bounds = {
              x1: n,
              y1: m + (b[h].margin + F),
              x2: k,
              ...
              width: k - n,
              height: V
            }, b[h].title && (b[h]._titleTextBlock.maxWidth = 0 < b[h].titleMaxWidth && b[h].titleMaxWidth < b[h].lineCoordinates.width ? b[h].titleMaxWidth : b[h].lineCoordinates.width), F += B[h] + b[h].margin);
          if (a && 0 < a.length) for (h = 0; h < a.length; h++) {
            K = a[h]._labels && 0 < a[h]._labels.length ? a[h]._labels[0].textBlock.fontSize / 2 : 0;
            n = Math.round(f.x1 + e);
            m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1) : f.y1 < Math.max(K, 10) ?
              Math.max(K, 10) : f.y1;
            k = Math.round(f.x1 + W + e);
            g = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - T) : f.y2 > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2;
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : n);
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, n = k -
              W);
            a[h].lineCoordinates = {x1: k - R, y1: m, x2: k - R, y2: g, height: Math.abs(g - m)};
            a[h].bounds = {x1: k - (G[h] + R), y1: m, x2: k, y2: g, width: k - n, height: g - m};
          ...
          if (d && 0 < d.length) for (h = 0; h < d.length; h++) {
            K = d[h]._labels && 0 < d[h]._labels.length ? d[h]._labels[0].textBlock.fontSize /
              2 : 0;
            n = Math.round(f.x1 - e);
            ...
            g = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - T) : f.y2 > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2;
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n =
              0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : n);
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, n = k - U);
            d[h].lineCoordinates = {x1: k + S, y1: m, x2: k + S, y2: g, height: Math.abs(g - m)};
            d[h].bounds = {x1: n, y1: m, x2: k + w[h] + S, y2: g, width: k - n, height: g - m};
          ...
          for (h = 0; h < p.length; h++) "axisY" === p[h].type && (p[h].calculateValueToPixelConversionParameters(), p[h].calculateBreaksSizeInValues());
          if (0 < v) {
            if (a && 0 < a.length) for (h = 0; h < a.length; h++) t = N[v - 1][h] === N[v][h] ? !0 : !1; else t = !0;
            if (d && 0 < d.length) for (h = 0; h < d.length; h++) I = P[v - 1][h] === P[v][h] ? !0 : !1; else I = !0;
            if (c && 0 < c.length) for (h = 0; h < c.length; h++) O = E[v - 1][h] === E[v][h] ? !0 : !1; else O = !0;
            if (b && 0 < b.length) for (h = 0; h < b.length; h++) M = u[v - 1][h] === u[v][h] ? !0 : !1; else M = !0
          }
          if (t && I && O && M) break;
          v++
        }
        if (c && 0 <
          c.length) for (h = 0; h < c.length; h++) c[h].calculateStripLinesThicknessInValues(), c[h].calculateBreaksInPixels();
        if (b && 0 < b.length) for (h = 0; h < b.length; h++) b[h].calculateStripLinesThicknessInValues(), b[h].calculateBreaksInPixels();
        if (a && 0 < a.length) for (h = 0; h < a.length; h++) a[h].calculateStripLinesThicknessInValues(), a[h].calculateBreaksInPixels();
        if (d && 0 < d.length) for (h = 0; h < d.length; h++) d[h].calculateStripLinesThicknessInValues(), d[h].calculateBreaksInPixels()
      }
    ...
    D.render = function (a, d, c, b, e) {
      ...
      if (b && 0 < b.length) for (m =
                                    0; m < b.length; m++) b[m].renderLabelsTicksAndTitle();
      f.preparePlotArea();
      f = f.plotArea;
      e.save();
      e.beginPath();
    ...
    D.prototype.calculateBreaksSizeInValues = function () {
      ...
      this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !s(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++) e = b || !s(d[f].options.spacing), d[f].spacing =
        Ra(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size))
    };
    D.prototype.calculateBreaksInPixels = function () {
      if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
        ...
        this.conversionParameters.minimum || (s(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d), a[d].startValue >= this.conversionParameters.minimum && (a[d].startPixel = this.convertValueToPixel(a[d].startValue), this.scaleBreaks.lastBreakIndex = d), a[d].endValue <= this.conversionParameters.maximum && (a[d].endPixel = this.convertValueToPixel(a[d].endValue)))
      }
    };
    D.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ("undefined" ===
        ...
        if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, m = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), g = this._labels.length - 1; 0 <= g; g--) {
            q = this._labels[g];
            if (q.position < this.viewportMinimum) break;
            q.position > this.viewportMaximum || !(g === this._labels.length - 1 || k < Math.log(m / q.position) * l / e) || (c.push(q), m = q.position, k =
          ...
          for (g = 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || (k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
        ...
        if ("left" === this._position || "right" === this._position) if (this.logarithmic &&
          ...
          for (var c = [], r, m = this.viewportMaximum, l = this.lineCoordinates.height / Math.log(this.range), g = this._labels.length - 1; 0 <= g; g--) {
            q = this._labels[g];
            if (q.position < this.viewportMinimum) break;
            q.position > this.viewportMaximum || !(g === this._labels.length - 1 || r < Math.log(m / q.position) * l) || (c.push(q), m = q.position, r = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
          }
          this._labels = c
        } else {
          for (g =
                 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || (r = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += r);
      ...
      if ("bottom" === this._position) {
        for (g = 0; g < this._labels.length; g++) q = this._labels[g],
        ...
        this.tickPlacement ? 0 : this.tickLength) - Math.abs(q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), q.textBlock.x = p.x, q.textBlock.y = p.y));
        "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          for (g = 0; g < a._labels.length; g++) if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position),
            a.tickThickness)) {
        ...
        "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          for (g = 0; g < a._labels.length; g++) if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
            a.ctx.lineWidth = a.tickThickness;
            a.ctx.strokeStyle = a.tickColor;
            var b = 1 === a.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0;
            a.ctx.save();
        ...
        for (g = 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || q.position > this.viewportMaximum || (p = this.getPixelCoordinatesOnAxis(q.position), this.tickThickness &&
        ...
        this.tickPlacement ? 0 : this.tickLength) - 5) : (q.textBlock.y = "inside" === this.labelPlacement ? p.y : p.y - q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), q.textBlock.x = "inside" === this.labelPlacement ? p.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : 0 < this.labelAngle ? p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5 : p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI /
          180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength))));
        "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          for (g = 0; g < a._labels.length; g++) if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
            a.ctx.lineWidth = a.tickThickness;
            a.ctx.strokeStyle = a.tickColor;
        ...
        for (g = 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || q.position > this.viewportMaximum || (p = this.getPixelCoordinatesOnAxis(q.position),
        this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (p.y << 0) + 0.5 : p.y << 0, this.ctx.beginPath(), this.ctx.moveTo(p.x << 0, b), this.ctx.lineTo(p.x + this.tickLength << 0, b), this.ctx.stroke()), d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (q.textBlock.y = p.y, q.textBlock.x = "inside" === this.labelPlacement ? p.x - q.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : p.x + ("inside" === this.tickPlacement ?
          ...
          ("inside" === this.tickPlacement ? 0 : this.tickLength) : p.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5)));
        "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          for (g = 0; g < a._labels.length; g++) if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
            a.ctx.lineWidth = a.tickThickness;
            a.ctx.strokeStyle = a.tickColor;
      ...
      if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function () {
        for (g = 0; g < a._labels.length; g++) q =
          a._labels[g], q.position < a.viewportMinimum || (q.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), q.textBlock.render(!0), a.ctx.restore())
      }, this); else for (g = 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || (q.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || q.textBlock.render(!0)
    };
    D.prototype.renderInterlacedColors = function () {
      ...
      if (("bottom" === this._position ||
        "top" === this._position) && this.interlacedColor) for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) d ? (d = this.getPixelCoordinatesOnAxis(this._labels[e].position), c = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(Math.min(c.x, d.x), b.y1, Math.abs(c.x - d.x), Math.abs(b.y1 - b.y2)), d = !1) : d = !0; else if (("left" === this._position || "right" === this._position) && this.interlacedColor) for (a.fillStyle = this.interlacedColor,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              e = 0; e < this._labels.length; e++) d ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position), d = e + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[e + 1].position), a.fillRect(b.x1, Math.min(c.y, d.y), Math.abs(b.x1 - b.x2), Math.abs(d.y - c.y)), d = !1) : d = !0;
      a.beginPath()
    };
    D.prototype.renderStripLinesOfThicknessType = function (a) {
      if (this.stripLines && 0 < this.stripLines.length && a) {
        for (var d = this, c, b = 0, e = 0, f = !1, k = !1, m = [], l = [], k = !1, b = 0; b < this.stripLines.length; b++) {
          var g =
            this.stripLines[b];
          g._thicknessType === a && ("pixel" === a && (g.value < this.viewportMinimum || g.value > this.viewportMaximum || s(g.value) || isNaN(this.range)) || m.push(g))
        }
        for (b = 0; b < this._stripLineLabels.length; b++) if (g = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
          a = this.getPixelCoordinatesOnAxis(c.position);
          if ("outside" === c.stripLine.labelPlacement) if (g && (this.ctx.strokeStyle = g.color, "pixel" === g._thicknessType && (this.ctx.lineWidth =
            g.thickness)), "bottom" === this._position) {
        ...
        if (!k) {
          ...
          this.ctx.clip();
          for (b = 0; b < m.length; b++) g = m[b], g.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
            this.ctx.save();
            this.ctx.beginPath();
            this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
            this.ctx.clip();
            for (e =
                   0; e < m.length; e++) g = m[e], g.showOnTop && g.render();
            this.ctx.restore()
          }, g)) : g.render();
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.setLineDash && d.setLineDash(P(this.lineDashType, this.lineThickness));
          var k = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 << 0;
          d.beginPath();
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(e,
            k), d.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[m].endPixel + b;
    ...
    D.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
        ...
        isFinite(f) ? isFinite(e) ? isFinite(f) || (f = e) : e = f : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -=
          b)), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < e && (e = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > f && (f = 0));
        ...
        if ("axisX" === this.type && c) {
          ...
          a ? (this.interval = 3, this.intervalType = "month") : b / (6 * S.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * S.yearDuration) <= a ? 1 : b / (2 * S.yearDuration) <= a ? 2 : b / (4 * S.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / S.yearDuration), this.intervalType = "year"));
          ...
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum)) this.viewportMaximum = "axisX" === this.type ? f + k / 2 :
        ...
        } else this.intervalType = this.valueType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? e - k / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ?
          Infinity : this.sessionVariables.viewportMinimum)), null === this.maximum && (this.maximum = "axisX" === this.type ? f + k / 2 : Math.ceil(f / this.interval) * this.interval, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)), 0 === this.maximum && 0 === this.minimum && (0 === this.options.minimum ? this.maximum += 10 : 0 === this.options.maximum && (this.minimum -= 10));
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      var m = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ?
      ...
      this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = D.getNiceExponent(Math.log(k) / d / (a - 1), !0), c = D.getNiceNumber(m / (a - 1), !0));
      ...
      "undefined" === typeof this.options.interval && (this.interval = D.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1)), c = D.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
      if (null === this.minimum || null === this.maximum) "axisX" === this.type ? (b = null !== this.minimum ? this.minimum : this.dataInfo.min, e = null !== this.maximum ? this.maximum : this.dataInfo.max, 1 === e / b && (k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval), e *= k, b /= k), f = Infinity !== this.dataInfo.minDiff ?
      ...
      if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
        ...
        this.interval = c
      } else this.options.interval || (c = Math.ceil(this.interval),
      this.range > this.interval && (this.interval = c, b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))), this.equidistantInterval = !0, this.intervalStartPosition = b;
    ...
    U.prototype.render = function (a) {
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        this.ctx.setLineDash && this.ctx.setLineDash(P(this.lineDashType, q));
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
          m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
          x1: b - q / 2,
          y1: e,
          x2: k + q / 2,
          y2: m
          ...
          f = 0.5;
          r = (m - g) / a / 3;
          for (var p = 0; p < r; p++) this.ctx.bezierCurveTo(l + f * a, g + a, l + f * a, g + 2 * a, l, g + 3 * a), g += 3 * a, f *= -1;
          this.ctx.bezierCurveTo(l +
            f * a, g + a, l + f * a, g + 2 * a, l, g + 3 * a);
          l = k;
          f *= -1;
          this.ctx.lineTo(l, g);
          for (p = 0; p < r; p++) this.ctx.bezierCurveTo(l + f * a, g - a, l + f * a, g - 2 * a, l, g - 3 * a), g -= 3 * a, f *= -1
        } else {
          if ("zigzag" === this.type) {
            f = -1;
            g = e + a;
            l = b + a;
            r = (m - g) / a / 2;
            for (p = 0; p < r; p++) this.ctx.lineTo(l, g), l += 2 * f * a, g += 2 * a, f *= -1;
            this.ctx.lineTo(l, g);
            l += k - b;
            for (p = 0; p < r + 1; p++) this.ctx.lineTo(l, g), l += 2 * f * a, g -= 2 * a, f *= -1;
            this.ctx.lineTo(l + f * a, g + a)
          }
        } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position) if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y <<
          0, m = 1 === q % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
          x1: b,
          y1: e - q / 2,
          x2: k,
          y2: m + q / 2
          ...
          r =
            (k - l) / a / 3;
          for (p = 0; p < r; p++) this.ctx.bezierCurveTo(l + a, g + f * a, l + 2 * a, g + f * a, l + 3 * a, g), l += 3 * a, f *= -1;
          this.ctx.bezierCurveTo(l + a, g + f * a, l + 2 * a, g + f * a, l + 3 * a, g);
          g = m;
          f *= -1;
          this.ctx.lineTo(l, g);
          for (p = 0; p < r; p++) this.ctx.bezierCurveTo(l - a, g + f * a, l - 2 * a, g + f * a, l - 3 * a, g), l -= 3 * a, f *= -1
          ...
          l = b + a;
          r = (k - l) / a / 2;
          for (p = 0; p < r; p++) this.ctx.lineTo(l, g), g += 2 * f * a, l += 2 * a, f *= -1;
          this.ctx.lineTo(l, g);
          g += m - e;
          for (p = 0; p < r + 1; p++) this.ctx.lineTo(l, g), g += 2 * f * a, l -= 2 * a, f *= -1;
          this.ctx.lineTo(l + a, g + f * a)
        }
        0 < q && this.ctx.stroke();
        this.ctx.closePath();
    ...
    M.prototype.render = function () {
      ...
      if (0 < d) {
        ...
        this.ctx.setLineDash(P(this.lineDashType, d));
    ...
    ba.prototype.showAt = function (a) {
      ...
      if ("xySwapped" === d.plotInfo.axisPlacement) if ("bottom" === this.parent._position) for (var b = 0; b < d.axisY.length; b++) this.parent === d.axisY[b] && (d.axisY[b]._crosshairValue = a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum ? a : null); else if ("top" === this.parent._position) for (b = 0; b <
      d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null); else if ("left" === this.parent._position) for (b = 0; b < d.axisX.length; b++) this.parent === d.axisX[b] && (d.axisX[b]._crosshairValue = a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum ? a : null); else {
        if ("right" === this.parent._position) for (b = 0; b < d.axisX2.length; b++) this.parent === d.axisX2[b] && (d.axisX2[b]._crosshairValue = a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum ?
          a : null)
        ...
        a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum ? a : null); else if ("right" === this.parent._position) for (b = 0; b < d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
      for (b = 0; b < d.axisX.length; b++) a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !s(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a), d.axisX[b].crosshair._updatedValue =
        a, this === d.axisX[b].crosshair && (c = !0));
      ...
      for (b = 0; b < d.axisY.length; b++) a = d.axisY[b]._crosshairValue, d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !s(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) &&
    ...
    ba.prototype.render = function (a, d, c) {
      var b, e, f, k, m = null, l = null, g = null, r = "";
      if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
        var q = 0,
          q = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) /
        ...
        this.valueFormatString = D.generateValueFormatString(this.parent.range, q)
      }
      var g = null === this.opacity ? 1 : this.opacity,
        q = Math.abs("pixel" === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness),
        p = this.chart.overlaidCanvasCtx, h = p.globalAlpha;
      p.globalAlpha = g;
      p.beginPath();
      ...
      0 < q && p.setLineDash && p.setLineDash(P(this.lineDashType, q));
      g = new la(p, {
        x: 0,
        y: 0,
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          if ("bottom" === this.parent._position ||
            "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) t = this.parent.convertPixelToValue({y: d});
          ...
          u < v && (v = u, w = t); else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
          x = r[w];
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
              ...
              m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) <<
                0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
              g.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options,
                crosshair: this.options,
                value: c ? c : x.dataPoint.y[b]
              }) : s(this.options.label) ? fa(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) : this.label
            } else if ("stackedBar" === this.parent.dataSeries[w].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y));
              z = u = 0;
              for (t = w; 0 <= t; t--) z += r[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(z)),
              u < v && (v = u, b = t);
              ...
              }) : s(this.options.label) ? fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label
            } else if ("stackedBar100" === this.parent.dataSeries[w].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y));
              E = z = u = 0;
              for (t = w; 0 <= t; t--) z +=
                r[t].dataPoint.y, E = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, E = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[E]), u = Math.abs(a - this.parent.convertValueToPixel(E)), u < v && (v = u, b = t);
              m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(E) << 0) + 0.5 : this.parent.convertValueToPixel(E) << 0;
              g.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
                axis: this.parent.options,
                crosshair: this.options,
                value: c ? c : E
              }) : s(this.options.label) ? fa(c ? c : E, this.valueFormatString, this.chart._cultureInfo) :
                this.label
            } else m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, g.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : x.dataPoint.y
            ...
            g.x = b - g.measureText().width /
              2;
            g.x + g.width > this.chart.bounds.x2 ? g.x = this.chart.bounds.x2 - g.width : g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1);
            g.y = this.parent.lineCoordinates.y2 + g.fontSize / 2 + 2;
            g.y + g.height > this.chart.bounds.y2 ? g.y = this.chart.bounds.y2 - g.height : g.y < this.chart.bounds.y1 && (g.y = this.chart.bounds.y1)
            ...
            E = !1;
            if (this.parent.labels) for (r = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += r) if (this.parent.labels[t]) E = !0; else {
              E = !1;
              break
            }
            if (E) {
              if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({y: d}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (g.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart, axis: this.parent.options,
                crosshair: this.options, value: x.dataPoint.x
              }) : s(this.options.label) ? v.dataPoint.label : this.label)
            } else "dateTime" === this.parent.valueType ? g.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : x.dataPoint.x
            }) : s(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (g.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart, axis: this.parent.options,
              crosshair: this.options, value: c ? c : x.dataPoint.x
            }) : s(this.options.label) ? fa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
            g.y = k + g.fontSize / 2 - g.measureText().height / 2 + 2;
            g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize / 2 + 2 : g.y + g.measureText().height - g.fontSize / 2 > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.measureText().height + g.fontSize / 2);
            "left" === this.parent._position ? g.x = this.parent.lineCoordinates.x2 - g.measureText().width : "right" === this.parent._position &&
              (g.x = this.parent.lineCoordinates.x2)
          }
          ...
          x = r[0];
          b = e = m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) <<
            0;
          f = this.chart.plotArea.y1;
          k = this.chart.plotArea.y2;
          this.bounds = {x1: b - q / 2, y1: f, x2: e + q / 2, y2: k};
          ...
          if (E) {
            if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({x: a}), v = null, w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (g.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
          ...
          g.x = b - g.measureText().width / 2;
          g.x + g.width > this.chart.bounds.x2 && (g.x = this.chart.bounds.x2 - g.width);
          g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1);
          "bottom" === this.parent._position ? g.y = this.parent.lineCoordinates.y2 + g.fontSize / 2 + 2 : "top" === this.parent._position && (g.y = this.parent.lineCoordinates.y1 - g.height + g.fontSize / 2 + 2)
        } else if ("left" ===
          this.parent._position || "right" === this.parent._position) {
          !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (t = this.parent.dataSeries[0].axisX.convertPixelToValue({x: a}));
          for (w = 0; w < this.parent.dataSeries.length; w++) (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && r.push(v));
          if (0 === r.length) return;
          r.sort(function (a, b) {
            return a.distance - b.distance
          ...
          w = 0;
          if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type ||
          ...
          x = r[w];
          b = 0;
          if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" ===
            this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
            ...
            z = u = 0;
            for (t = w; 0 <= t; t--) z += r[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)),
            u < v && (v = u, b = t);
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y));
            z = u = 0;
            for (t = w; 0 <= t; t--) z += r[t].dataPoint.y, E = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, E = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[E]), u = Math.abs(d - this.parent.convertValueToPixel(E)), u < v && (v = u, b = t);
            l = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(E) << 0) + 0.5 : this.parent.convertValueToPixel(E) << 0;
            g.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : E
            }) : s(this.options.label) ? fa(c ? c : E, this.valueFormatString,
              this.chart._cultureInfo) : this.label;
            this.value = E
          } else "waterfall" === this.parent.dataSeries[w].type ? (l = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
          }) : s(this.options.label) ? fa(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum,
            this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (l = 1 === p.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: x.dataPoint.y
          }) : s(this.options.label) ? fa(c ? c : x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value =
            x.dataPoint.y);
          f = k = l;
          b = this.chart.plotArea.x1;
          e = this.chart.plotArea.x2;
          ...
          g.y = k + g.fontSize / 2 - g.measureText().height / 2 + 2;
          g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize / 2 + 2 : g.y + g.measureText().height - g.fontSize / 2 > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.measureText().height + g.fontSize / 2);
          "left" === this.parent._position ? g.x = this.parent.lineCoordinates.x2 - g.measureText().width : "right" === this.parent._position && (g.x = this.parent.lineCoordinates.x2)
        }
        r =
          null;
        if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 && (g.y = this.chart.bounds.y1 + g.fontSize / 2), "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - g.fontSize / 2 + g.measureText().height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.viewportMaximum) && (0 < q && (p.moveTo(b,
          f), p.lineTo(e, k), p.stroke(), this._hidden = !1), p.restore(), !s(g.text) && ("number" === typeof g.text.valueOf() || 0 < g.text.length) && g.render(!0));
        if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1), "right" === this.parent._position && g.x + g.measureText().width > this.chart.bounds.x2 && (g.x = this.chart.bounds.x2 - g.measureText().width), k >= this.parent.convertValueToPixel(this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.viewportMinimum) &&
        (0 < q && (p.moveTo(b, f), p.lineTo(e, k), p.stroke(), this._hidden = !1), p.restore(), !s(g.text) && ("number" === typeof g.text.valueOf() || 0 < g.text.length) && g.render(!0))
      } else {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
          ...
          if (E) {
            ...
            this.label : "number" === this.parent.valueType && (g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(d)
          }) : s(this.options.label) ? fa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
          g.y = d + g.fontSize / 2 - g.measureText().height / 2 + 2;
          g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize / 2 + 2 : g.y + g.measureText().height - g.fontSize / 2 > this.chart.bounds.y2 &&
            (g.y = this.chart.bounds.y2 - g.measureText().height + g.fontSize / 2);
          "left" === this.parent._position ? g.x = this.parent.lineCoordinates.x1 - g.measureText().width : "right" === this.parent._position && (g.x = this.parent.lineCoordinates.x2)
        } else {
          if ("bottom" === this.parent._position || "top" === this.parent._position) g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(a)
          }) : s(this.options.label) ? fa(c ? c : this.parent.convertPixelToValue(a),
            this.valueFormatString, this.chart._cultureInfo) : this.label, g.x = b - g.measureText().width / 2, g.x + g.width > this.chart.bounds.x2 && (g.x = this.chart.bounds.x2 - g.width), g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1), "bottom" === this.parent._position ? g.y = this.parent.lineCoordinates.y2 + g.fontSize / 2 + 2 : "top" === this.parent._position && (g.y = this.parent.lineCoordinates.y1 - g.height + g.fontSize / 2 + 2)
        } else if ("bottom" === this.parent._position || "top" === this.parent._position) {
          E = !1;
          r = "";
          if (this.parent.labels) for (r = Math.ceil(this.parent.interval),
                                         t = 0; t < this.parent.viewportMaximum; t += r) if (this.parent.labels[t]) E = !0; else {
            E = !1;
            break
          }
          if (E) {
          ...
          this.parent.valueType ? g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(a)
          }) : s(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (g.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) :
              ""
          }) : s(this.options.label) ? fa(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label);
          g.x = b - g.measureText().width / 2;
          g.x + g.width > this.chart.bounds.x2 && (g.x = this.chart.bounds.x2 - g.width);
          g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1);
          "bottom" === this.parent._position ? g.y = this.parent.lineCoordinates.y2 + g.fontSize / 2 + 2 : "top" === this.parent._position && (g.y = this.parent.lineCoordinates.y1 - g.height + g.fontSize / 2 + 2)
        } else if ("left" === this.parent._position || "right" ===
          this.parent._position) g.text = this.labelFormatter ? this.labelFormatter({
          chart: this.chart,
          axis: this.parent.options,
          crosshair: this.options,
          value: c ? c : this.parent.convertPixelToValue(d)
          ...
          g.measureText().height + g.fontSize / 2), "left" === this.parent._position ? g.x = this.parent.lineCoordinates.x2 - g.measureText().width : "right" === this.parent._position && (g.x = this.parent.lineCoordinates.x2);
        "left" === this.parent._position && g.x < this.chart.bounds.x1 ? g.x = this.chart.bounds.x1 : "right" === this.parent._position && g.x + g.measureText().width > this.chart.bounds.x2 ? g.x = this.chart.bounds.x2 - g.measureText().width : "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize /
          2 : "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - g.fontSize / 2 + g.measureText().height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2);
        0 < q && (p.moveTo(b, f), p.lineTo(e, k), p.stroke(), this._hidden = !1);
        p.restore();
        !s(g.text) && ("number" === typeof g.text.valueOf() || 0 < g.text.length) && g.render(!0);
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX) for (var l = 0; l < this.chart.axisX.length; l++) {
              for (var k =
                this.chart.axisX[l].convertPixelToValue({y: d}), g = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) (g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX[l].dataSeries[b], null !== g.dataPoint.y && m.push(g));
              g = null
            }
            if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) {
              k = this.chart.axisX2[l].convertPixelToValue({y: d});
              g = null;
              for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++) (g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index &&
              (g.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== g.dataPoint.y && m.push(g));
              g = null
            }
          } else {
            m = [];
            if (this.chart.axisX) for (l = 0; l < this.chart.axisX.length; l++) for (k = this.chart.axisX[l].convertPixelToValue({x: a}), g = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) (g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX[l].dataSeries[b], null !== g.dataPoint.y && m.push(g));
            if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) for (k = this.chart.axisX2[l].convertPixelToValue({x: a}),
                                                                                         g = null, b = 0; b < this.chart.axisX2[l].dataSeries.length; b++) (g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== g.dataPoint.y && m.push(g))
          }
          ...
          if (g = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex =
            g.dataSeries.index; else if (t) if (g = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex) b =
              ...
              g = e.getDataPointAtX(k, c);
              s(g) || (g.dataSeries = e, this.currentDataPointIndex = g.index, b = g.dataPoint)
            }
            if (!s(g) && !s(g.dataPoint) && !s(g.dataPoint.y)) if (g.dataSeries.axisY) if (0 < g.dataPoint.y.length) {
              for (b = c = 0; b < g.dataPoint.y.length; b++) g.dataPoint.y[b] < g.dataSeries.axisY.viewportMinimum ? c-- : g.dataPoint.y[b] > g.dataSeries.axisY.viewportMaximum &&
                c++;
              c < g.dataPoint.y.length && c > -g.dataPoint.y.length && f.push(g)
            } else "column" === e.type || "bar" === e.type ? 0 > g.dataPoint.y ? 0 > g.dataSeries.axisY.viewportMinimum && g.dataSeries.axisY.viewportMaximum >= g.dataPoint.y && f.push(g) : g.dataSeries.axisY.viewportMinimum <= g.dataPoint.y && 0 <= g.dataSeries.axisY.viewportMaximum && f.push(g) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[g.index]].size / 2, g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum - c && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum +
    ...
    $.prototype.highlightObjects = function (a) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
          var b = this.chart.data[e.dataSeriesIndex], f = b.dataPoints[e.dataPointIndex], k = e.dataPointIndex;
    ...
    $.prototype.getToolTipInnerHTML = function (a) {
      ...
      if (k && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
        ...
        for (var s = null, g = "", l = 0; l < a.length; l++) c = a[l].dataSeries, b = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? g += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ?
    ...
    ea.prototype.mouseEventHandler = function (a) {
      if ("mousemove" === a.type || "click" === a.type) {
        ...
        if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
          var e = this.chart.data[b.dataSeriesIndex], f = e.dataPoints[b.dataPointIndex], k = b.dataPointIndex;
          b.eventParameter = {
    ...
    var N = {
      ...
      drawMarker: function (a,
        ...
        if (c) {
          ...
          c.lineWidth = l ? l : 0;
          c.setLineDash && c.setLineDash(P("solid", l));
