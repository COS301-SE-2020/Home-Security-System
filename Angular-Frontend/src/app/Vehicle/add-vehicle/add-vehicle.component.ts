...
export class AddVehicleComponent implements OnInit {
  ...
  constructor(private vehicleService: VehicleService, private imageService: ImageService,
  ...
  ngOnInit(): void {
    this.appService.setTitle('Add Vehicle');
  }

  returnVehicleListed(): string{
  ...
  addVehicle(): void{
    const addMake = document.getElementById('vmake') as HTMLInputElement;
    const addModel = document.getElementById('model') as HTMLInputElement;
    const addColour = document.getElementById('colour') as HTMLInputElement;
    const addReg = document.getElementById('licenceNo') as HTMLInputElement;
    const photoInp = document.getElementById('submitPhoto').getAttribute('src');
    const getListed = this.returnVehicleListed();
